label wardrobe_import():
    $ list_of_xml_files = []
    # Build a list of all possible files inside the imports file.
    python:
    ...
    if not list_of_xml_files:
        "No files found. Place wardrobe XML files inside games/wardrobes/imports to make them available for importing."
        return
