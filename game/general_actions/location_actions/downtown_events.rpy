init -1 python:
    ...
    def get_downtown_event_list():
        ...
        return list_of_downtown_events

    def get_downtown_search_event():
        possible_downtown_events = []
        for possible_event in get_downtown_event_list(): #Make a list of the valid events.
...
label lady_of_the_night_label():
    ...
    menu:
        "Pay her\n{menu_red}Costs: $200{/menu_red}" if mc.business.has_funds(200):
            ...
            call person_introduction(the_person, girl_introduction = False) from _call_person_introduction_lady_of_the_night
...
label meet_person_label():
    # You see a woman drop some cash out of her purse. YOu can either return it for an introduction+bonus love OR
    # Keep it because it's money and you like money.
    $ the_person = make_person()
    $ the_person.draw_person(position = "walking_away")
            ...
            menu:
                "Ask for her number":
                    ...
                    if not the_person.has_significant_other or the_person.opinion.cheating_on_men > 0:
                        ...
                        the_person "I don't know... I've got a [the_person.so_title], I don't want him getting the wrong idea."
                        menu:
                            ...
                            "Convince her\n{menu_red}Requires: 3 Charisma{/menu_red} (disabled)" if mc.charisma < 3:
                                pass
