init 1 python:
    def get_strip_menu_options(person):
        ...
        for item in person.outfit.get_unanchored():
            ...
            new_willingness = person.effective_sluttiness("underwear_nudity") + (5*person.opinion.not_wearing_anything) - test_outfit.outfit_slut_score
            ...
            if new_willingness + (person.obedience-100) >= -20:
                ...
                price = builtins.math.ceil((price/5.0))*5 #Round up to the next $5 increment
                if price > 0:
                ...
                display_string += "\n{menu_red}Costs: " + price_display + "{/menu_red}"
                ...
                if taboo_break:
                    display_string = "{image=gui/extra_images/taboo_break_token.png} " + display_string + " {image=gui/extra_images/taboo_break_token.png}"
                pay_strip_list.append((display_string + "\n{menu_red}Too Slutty{/menu_red} (disabled)", (item, -1)))
...
label pay_strip_scene(the_person):
    ...
    $ strip_willingness = the_person.effective_sluttiness("underwear_nudity") + (5*the_person.opinion.not_wearing_anything) - the_person.outfit.outfit_slut_score
    ...
    while keep_stripping:
        ...
        if strip_willingness < 0:
            ...
            if ran_num == 0:
                ...
                if tease_clothing is not None:
                    ...
                    "[the_person.title] takes a wider stance and slides her hands down her own thighs, all while maintaining eye contact with you."
        ...
        call screen main_choice_display(build_menu_items(get_strip_menu_options(the_person)))
        ...
        if strip_choice == "Watch":
            if renpy.random.randint(0,1) == 0:
                ...
                if renpy.random.randint(0,100) < free_spirit_threshold: #She's independent enough to strip, change pose, etc. on her own.
                    if tease_item is not None and new_willingness >= (the_person.obedience-100): #A more obedient person is less willing to strip without being told to. A less obedient person will strip further on their own.
                        ...
                        $ new_willingness = the_person.sluttiness + (5*the_person.opinion.not_wearing_anything) - test_outfit.outfit_slut_score
                        $ price = 0
                        $ taboo_break = False
                        ...
                        if price > 0:
                            ...
                            menu:
                                "Pay her\n{menu_red}Costs: $[price]{/menu_red}" if mc.business.has_funds(price):
                                    "You pull the cash out of your wallet and hand it over."
                                    $ mc.business.change_funds(-price, stat = "Strippers")
                                    $ the_person.change_stats(obedience = -1, slut = 1, max_slut = 40)
                                ...
                                "Pay her\n{menu_red}Requires: $[price]{/menu_red} (disabled)" if not mc.business.has_funds(price):
                                    pass
            ...
            $ mc.business.change_funds(-strip_choice[1], stat = "Strippers")
            ...
            $ strip_willingness = the_person.effective_sluttiness("underwear_nudity") + (5*the_person.opinion.not_wearing_anything) - test_outfit.outfit_slut_score
            mc.name "Take off your [the_clothing.display_name] for me."
            if taboo_break: #Always use special dialogue for the taboo breaks
                $ the_person.call_dialogue(f"{taboo_break}_taboo_break", the_clothing = the_clothing)
            ...
            if strip_choice[1] > 0:
                if strip_willingness < 0:
                    ...
                    $ the_person.change_stats(obedience = 2, slut = 1, max_slut = 40)
    ...
    def get_strip_tease_menu_options(person, guy_state, girl_state):
        ...
        for next_position in girl_state.leads_to:
            if person.effective_sluttiness() < next_position[0].slut_requirement:
                command_options.append((next_position[1] + "\n{menu_red}Requires: " + get_gold_heart(next_position[0].slut_requirement) + "{/menu_red} (disabled)", next_position[0]))
            else:
...
label strip_tease(the_person, in_private = True, for_pay = False, start_girl_direction = None, start_guy_state = None, start_girl_state = None, skip_intro = False):
    ...
    # -> Lapdance - Grinding her body against yours. If your cock is out she's rubbing it between her ass cheeks, if not it's uncomfortably hard.
    ...
    if start_girl_state is None:
        ...
        $ slut_requirement = 35 - 5*(the_person.opinion.showing_her_tits+the_person.opinion.showing_her_ass)
        if not in_private:
            $ slut_requirement += 15
    ...
    $ apply_sex_modifiers(the_person, in_private)

    if start_guy_state is None:
        $ guy_state = "watching" # Other possibilities include: Jerking off, Touching.
    else:
    ...
    while should_continue and not the_person is None:
        ...
        call screen main_choice_display(build_menu_items(get_strip_tease_menu_options(the_person, guy_state, girl_state)))
        ...
        if isinstance(the_choice, Clothing): #Strip if you've offered to pay her something.
            ...
            "You unzip your pants and pull out your cock. Its hard shaft falls easily into your hand as you watch [the_person.title]."
            $ guy_state = "jerking"
            if the_person.effective_sluttiness() < girl_state.slut_requirement + 10:
                ...
                if girl_direction == "away":
                    ...
                    "[the_person.possessive_title!c] is shocked to the point of silence for a moment."
                ...
                menu:
                    "Pay her\n{menu_red}Costs: $200{/menu_red}" if mc.business.has_funds(200) and for_pay:
                        ...
                        $ the_person.change_stats(obedience = 1, love = -1, slut = 1, max_slut = 30)
                        $ mc.business.change_funds(-200, stat = "Strippers")
                        the_person "Fine, just don't... think this is going any further!"

                    "Pay her\n{menu_red}Requires: $200{/menu_red} (disabled)" if not mc.business.has_funds(200) and for_pay:
                        pass
            ...
            if the_person.effective_sluttiness("touching_body") < girl_state.slut_requirement + 20:
                "[the_person.possessive_title!c] jumps away from you in surprise."
                ...
                if for_pay:
                    "[the_person.possessive_title!c] jumps away from you, more surprise than anger."
                    ...
                    menu:
                        ...
                        "Order her\n{menu_red}Requires: 125 Obedience{/menu_red} (disabled)" if the_person.obedience < 125:
                            pass
                ...
                "[the_person.possessive_title!c] leans her body into your hands seductively, encouraging you to touch her more."


            if guy_state == "touching":
                if the_person.has_taboo("touching_body"):
                    "[the_person.possessive_title!c] seems nervous at first, but quickly becomes comfortable having your hands all over her."
                    $ the_person.break_taboo("touching_body")
            ...
            if the_person.effective_sluttiness() < 15:
                "[the_person.possessive_title!c] is visibly relieved. She takes a deep sigh and smiles."
            ...
            if report_log.get("guy orgasms", 0) == 0 and report_log.get("girl orgasms") == 0:
                "[the_person.possessive_title!c] looks a little disappointed."
            ...
            elif report_log.get("guy orgasms", 0) > 1:
                "[the_person.possessive_title!c] is looking at you with a big smile on her face."
                the_person "I noticed that you loved my performance, thank you [the_person.mc_title]."
            elif report_log.get("guy orgasms", 0) > 0:
                "[the_person.possessive_title!c] has a smile on her face."
                the_person "I think you enjoyed my little performance."
            else: # girl had orgasm
                "[the_person.possessive_title!c] looks a little uncertain."
                the_person "I'm sorry [the_person.mc_title], that was not very professional of me."
            ...
            if the_person.judge_outfit(the_person.outfit): # She's comfortable wearing what she has on, she'll consider stripping something off.
                if the_person.outfit.remove_random_any(top_layer_first = True, exclude_feet = True, do_not_remove = True) is not None: #Checks that something can actually be stripped, as is necessary below
            ...
            if girl_action == "nothing":
                ...
                if the_clothing is None:
                    ...
                    if taboo_break is None and (the_person.judge_outfit(test_outfit, -20 + (5 * the_person.opinion(("showing her tits", "showing her ass")))) or (not for_pay and the_person.judge_outfit(test_outfit))):
                        the_person "Let's get this out of the way..."
                        "[the_person.possessive_title!c] hooks a thumb under her [the_clothing.display_name]."
                        ...
                        menu:
                            "Pay her\n{menu_red}Costs: $[strip_cost]{/menu_red}" if mc.business.has_funds(strip_cost) and for_pay:
                                $ the_item = the_person.outfit.get_lower_top_layer
                                if girl_state.is_close and the_item and the_item.underwear: #Slip it into her g-string or similar.
                                    "You pull out some cash and slip it carefully into the waist of her [the_item.display_name]."
                                    if girl_direction == "away":
                                        $ play_spank_sound()
                                ...
                                $ the_item = None
                                if not the_person.is_dominant:
                                    $ the_person.change_obedience(-the_person.opinion.taking_control, max_amount = 160) #Putting her in control builds her confidence.
                                $ mc.business.change_funds(-strip_cost, stat = "Strippers")

                            "Pay her\n{menu_red}Requires: $[strip_cost]{/menu_red} (disabled)" if not mc.business.has_funds(strip_cost) and for_pay:
                                pass
                            ...
                            "Encourage her" if not for_pay:
                                ...
                                if renpy.random.randint(0,100) < (the_person.love + the_person.obedience - 100):
                                    "[the_person.possessive_title!c] thinks for a moment, then nods and smiles."
                                    the_person "Alright, only because it's you."
                                    if not the_person.is_dominant:
                                        $ the_person.change_obedience(-the_person.opinion.taking_control, max_amount = 160) #Putting her in control builds her confidence.

                                else:
                                    "[the_person.possessive_title!c] thinks for a moment, then shakes her head."
                            ...
                            "Say nothing" if not for_pay:
                                "You don't say anything. [the_person.possessive_title!c] moves on, quickly, but seems a little disappointed she couldn't take things further."
                                $ do_strip = False
                ...
                menu:
                    ...
                    "Don't do anything":
                        ...
                        "[the_person.possessive_title!c] seems a little disappointed, but doesn't say any more."
        ...
        if the_choice == "description": #NOTE: Not an else-if, this is always run if the results above call for a description.
            ...
            if girl_state.girl_energy_cost > the_person.energy:
                ...
                $ guy_arousal_change = girl_state.guy_arousal_gain + the_person.foreplay_sex_skill
                $ girl_arousal_change = girl_state.girl_arousal_gain # This should usually be 0 unless they have some specific Opinions.
                $ girl_arousal_change += the_person.opinion(("showing her tits", "showing her ass"))
                if not in_private and mc.location.person_count > 1:
                    $ girl_arousal_change += the_person.opinion.public_sex
                ...
                if mc.arousal_perc >= 80:
                    ...
                    $ is_cumming = _return
                    if is_cumming:
                        call strip_tease_guy_cum(the_person, girl_state, girl_direction, guy_state, for_pay = for_pay) from _call_strip_tease_guy_cum
        ...
        if the_choice == "exhausted":
            "[the_person.possessive_title!c] looks tired. She wipes her brow and sighs."
...
label strip_tease_remove(the_person, the_clothing, girl_state, girl_direction, guy_state, for_pay = False):
    ...
    if the_person.judge_outfit(test_outfit, -20) and not taboo_break:
    ...
    elif the_person.judge_outfit(test_outfit, 0 + (5 * the_person.opinion(("showing her tits", "showing her ass")))):
    ...
    elif the_person.judge_outfit(test_outfit, 20 + (5 * the_person.opinion(("showing her tits", "showing her ass")))): #She's uncomfortable with it, but she'll do it if you command her or pay her a lot.
        $ resists_strip = True
        $ resist_level = "mid"
        ...
        $ pay_obedience_requirement = 130 - the_person.opinion.being_submissive * 5
    ...
    if resists_strip: #TODO: All of this could probably be personality based dialogue, with different sections for the different resist levels.
        if resist_level == "low": #NOTE: All low resists are because they want cash.
            ...
            if for_pay:
                if taboo_break == "bare_pussy":
                    ...
                    "[the_person.possessive_title!c] thinks for a long moment, obviously conflicted."
                ...
                if taboo_break == "bare_pussy":
                    ...
                    "[the_person.possessive_title!c] looks uncomfortable for a moment and shakes her head."
                    ...
                    "[the_person.possessive_title!c] seems uncomfortable with the idea."
        ...
        $ do_strip = False
        menu:
            "Pay her\n{menu_red}Costs: $[strip_cost]{/menu_red}" if mc.business.has_funds(strip_cost) and for_pay and not resist_level == "high":
                $ the_item = the_person.outfit.get_lower_top_layer
                if girl_state.is_close and the_item and the_item.underwear: #Slip it into her g-string or similar.
                    "You pull out some cash and slip it carefully into the waist of her [the_item.display_name]."
                    if girl_direction == "away":
            ...
            "Pay her\n{menu_red}Requires: $[strip_cost]{/menu_red} (disabled)" if not mc.business.has_funds(strip_cost) and for_pay and not resist_level == "high":
                pass

            "Pay her\n{menu_red}Costs: $[strip_cost]{/menu_red}" if resist_level == "high" and for_pay and mc.business.has_funds(strip_cost) and the_person.obedience >= pay_obedience_requirement:
                ...
                $ the_person.change_love(-1)
                "[the_person.possessive_title!c] looks shocked, but she can't take her eyes off of your money."
                "After a long moment of thought her resolve breaks down."
                "She snatches the money from you, looking guilty while she does so."
                $ mc.business.change_funds(-strip_cost, stat = "Strippers")
                $ do_strip = True

            "Pay her\n{menu_red}Requires: $[strip_cost], [pay_obedience_requirement] Obedience{/menu_red} (disabled)" if resist_level == "high" and for_pay and (not mc.business.has_funds(strip_cost) or the_person.obedience < pay_obedience_requirement):
                pass
            ...
            "Order her" if the_person.obedience >= obedience_requirement:
                ...
                if resist_level == "high":
                    ...
                    "[the_person.possessive_title!c] nods and follows your instructions."
                else:
                    if for_pay:
                        ...
                        "[the_person.possessive_title!c] understands and follows your instructions."
                    else:
...
label strip_tease_guy_cum(the_person, girl_state, girl_direction, guy_state, for_pay = False): #TODO: The rest of this
    ...
    if not guy_state == "jerking":
        ...
        if the_choice == "Pull out your cock":
            ...
            if girl_direction == "towards":
                ...
                if renpy.random.randint(0,100) < 20*the_person.focus+10:
                    "[the_person.possessive_title!c] glances over her shoulder, immediately noticing your twitching dick."
                    $ girl_aware = True
                else:
                    "[the_person.possessive_title!c] has her back to you, and is completely unaware."

            if girl_aware:
                if the_person.effective_sluttiness() < 20:
                    the_person "Oh my god, what are you doing?"
                    mc.name "Fuck, I can't take it, I'm going to cum!"
                    "Her eyes go wide and she takes a few steps back."
                elif the_person.effective_sluttiness() < 40:
                    the_person "[the_person.mc_title], what are you doing?"
                    the_person "You really shouldn't..."
                    mc.name "Fuck, I'm going to cum!"
                    "[the_person.possessive_title!c] takes a moment to process that as you stroke yourself off."
                    the_person "Oh? Oh!"
                else:
        ...
        #TODO: If she's looking towards you we'll do some basic checks, and she always becomes aware (because you can't hide why you whipped your cock out.)
    ...
    if the_choice == "Cum on the floor":
        ...
        if girl_aware or girl_direction == "towards":
            if the_person.effective_sluttiness() < 20:
                ...
                $ the_person.change_stats(happiness = -5, obedience = -2, love = -1)
            ...
            if the_person.effective_sluttiness() < 20:
                ...
                if the_person.opinion(("drinking cum", "being covered in cum", "cum facials")) > 0:
        ...
        if girl_aware:
            if the_person.effective_sluttiness() + 5 * the_person.opinion.being_covered_in_cum < 20:
            ...
            elif the_person.effective_sluttiness() + 5 * the_person.opinion.being_covered_in_cum < 40:
                ...
                $ the_person.change_happiness(-5 + 5*the_person.opinion.being_covered_in_cum)
                ...
                $ the_person.change_happiness(5*the_person.opinion.being_covered_in_cum)
            ...
            if the_person.effective_sluttiness() + 5 * the_person.opinion.being_covered_in_cum< 20:
                ...
                $ the_person.change_stats(happiness = -10, love = -4)
                ...
                "[the_person.title] turns around and looks at you, eyes flicking between your face and your still-hard cock."
                the_person "Oh my god! Is that... Did you just cum on me?"
                $ the_person.change_stats(happiness = -5 + 5 * the_person.opinion.being_covered_in_cum, obedience = -1)
                mc.name "Yeah, sorry about that. I just couldn't hold back any more."
        ...
        if girl_aware:
            if the_person.effective_sluttiness() + 5 * the_person.opinion.being_covered_in_cum < 20:
                ...
                "You shrug and pant, trying to catch your breath."
                mc.name "Sorry, you just pushed me over the edge and I couldn't stop myself."
                $ the_person.change_stats(happiness = -10, love = -2, slut = 1 + the_person.opinion.being_covered_in_cum, max_slut = 40)
                the_person "So this is my fault?"
                "You shrug again. She scowls at you, but doesn't have much more she can say about it."
            elif the_person.effective_sluttiness() + 5 * the_person.opinion.being_covered_in_cum < 40:
                "[the_person.title] looks at you, eyes flicking between your face and your still-hard cock."
                the_person "Oh my god! Is that... Did you just cum on me?"
                $ the_person.change_stats(happiness = -5 + 5 * the_person.opinion.being_covered_in_cum, slut = 1 + the_person.opinion.being_covered_in_cum, max_slut = 40)
                mc.name "Yeah, sorry about that. I just couldn't hold back any more."
                the_person "Right..."
            else:
            ...
            if the_person.effective_sluttiness() + 5 * the_person.opinion.being_covered_in_cum < 20:
                ...
                "You see a series of emotions pass across her face—surprise, understanding, maybe a hint of arousal, and finally anger."
                the_person "What the hell! Did you just... Oh my god, you just came on me!"
                $ the_person.change_stats(happiness = -10, love = -4, slut = 2 + the_person.opinion.being_covered_in_cum, max_slut = 40)
                "You take a few deep breaths to try and recover from your orgasm, then shrug."
                mc.name "Yeah, sorry about that. It just sort of... happened."
                "Her eyes keep darting between your dick and your face, as if she can't decide which deserves her focus right now."
                the_person "\"Just happened\"? Oh my god, how did I let this happen..."
                ...
                "[the_person.title] stops moving, her eyes locked onto your still-pulsing cock."
                the_person "Oh my god! Is that... Did you just cum on me?"
                $ the_person.change_stats(happiness = -5 + 5*the_person.opinion.being_covered_in_cum, obedience = -1, slut = 2 + the_person.opinion.being_covered_in_cum, max_slut = 40)
                mc.name "Yeah, sorry about that. I just couldn't hold back any more."
                the_person "Right... Just give me some warning next time, alright?"
                the_person "I really don't appreciate the surprise."
            else:
        ...
        $ pay_after = False
        if the_person.effective_sluttiness() + 5 * the_person.opinion.being_covered_in_cum < 25: #Not willing no matter what.
        ...
        elif the_person.effective_sluttiness() + 5 * the_person.opinion.being_covered_in_cum < 45:
            $ cum_cost = 50
            $ obedience_requirement = 130 - 5*the_person.opinion.being_covered_in_cum
            if the_person.opinion.being_covered_in_cum < 0:
                $ cum_cost = cum_cost * -the_person.opinion.being_covered_in_cum
            ...
            menu:
                "Pay her\n{menu_red}Costs: $[cum_cost]{/menu_red}" if mc.business.has_funds(cum_cost) and for_pay:
                    $ pay_after = True
                    mc.name "Fine! Whatever you want!"
                    $ the_person.change_obedience(-(1 + the_person.opinion.being_submissive), max_amount = 160) #She loses obedience, more if she likes being submissive (you're begging her!)
                    "You struggle to hold back your orgasm while [the_person.title] gets onto her knees."

                "Pay her\n{menu_red}Requires: $[cum_cost]{/menu_red} (disabled)" if not mc.business.has_funds(cum_cost) and for_pay:
                    pass
                ...
                "Order her" if the_person.obedience >= obedience_requirement:
                    ...
                    if the_person.opinion.being_covered_in_cum < 0:
                        $ the_person.discover_opinion("being covered in cum")
                        $ the_person.change_obedience(-the_person.opinion.being_covered_in_cum, max_amount = 160) #Increases her obedience if you force her to take a cumshot in a way she doesn't like.
                        $ the_person.change_love(the_person.opinion.being_covered_in_cum)
                        "[the_person.possessive_title!c] seems appalled by the idea, but obeys and gets onto her knees."
                    else:
                ...
                "Ignore her":
                    ...
                    "[the_person.possessive_title!c] takes a step back, clearing the splash zone."
                    $ cum_on_floor_instead = True
        ...
        if cum_on_floor_instead:
            ...
            $ climax_controller.do_clarity_release(the_person)
            "You grunt and climax, blowing your load out onto the floor in thick ropes of hot cum."
            $ the_person.change_slut(the_person.opinion(("being covered in cum","cum facials", "creampies", "drinking cum")), 40)
            ...
            if pay_after:
                ...
                $ mc.business.change_funds(-cum_cost, stat = "Strippers")
            else:
        ...
        $ cum_on_floor_instead = False
        $ pay_after = False
        if the_person.effective_sluttiness() + 5 * the_person.opinion.cum_facials < 35:
            "[the_person.title] shakes her head."
            the_person "What? Of course not!"
            "You want to argue, but you're out of time!"
            $ cum_on_floor_instead = True

        elif the_person.effective_sluttiness() + 5 * the_person.opinion.cum_facials < 55:
            $ cum_cost = 100
            $ obedience_requirement = 130 - 5*the_person.opinion.cum_facials
            if the_person.opinion.cum_facials < 0:
                $ cum_cost = cum_cost * -the_person.opinion.cum_facials
            ...
            menu:
                "Pay her\n{menu_red}Costs: $[cum_cost]{/menu_red}" if mc.business.has_funds(cum_cost) and for_pay:
                    $ pay_after = True
                    mc.name "Fine! Whatever you want!"
                    $ the_person.change_obedience(-(1 + the_person.opinion.being_submissive), max_amount = 160)
                    "You struggle to hold back your orgasm while [the_person.title] gets onto her knees."
                ...
                "Order her" if the_person.obedience >= obedience_requirement:
                    ...
                    if the_person.opinion.cum_facials < 0:
                        ...
                        $ the_person.change_obedience(-the_person.opinion.cum_facials, max_amount = 160)
                        $ the_person.change_love(the_person.opinion.cum_facials)
                        "[the_person.possessive_title!c] seems appalled by the idea, but obeys and gets onto her knees."
                    else:
                        "You struggle to hold back your orgasm while [the_person.title] obeys and gets onto her knees."
        ...
        if cum_on_floor_instead:
            ...
            if the_person.opinion.drinking_cum > 0:
                "[the_person.possessive_title!c] looks up at you from her knees and sticks her tongue out, ready to take your load."
            else:
                "[the_person.possessive_title!c] looks up at you from her knees, waiting for her facial."
            $ climax_controller.do_clarity_release(the_person)
        ...
        $ cum_on_floor_instead = False
        $ pay_after = False
        if the_person.effective_sluttiness() + 5 * the_person.opinion.drinking_cum < 45:
            "[the_person.title] shakes her head."
            the_person "What? In my mouth? Of course not!"
            "You want to argue, but you're out of time!"
            $ cum_on_floor_instead = True

        elif the_person.effective_sluttiness() + 5 * the_person.opinion.drinking_cum < 65:
            $ cum_cost = 200
            $ obedience_requirement = 130 - 5*the_person.opinion.drinking_cum
            if the_person.opinion.drinking_cum < 0:
                $ cum_cost = cum_cost * -the_person.opinion.drinking_cum
            ...
            menu:
                ...
                "Order her" if the_person.obedience >= obedience_requirement:
                    ...
                    if the_person.opinion.drinking_cum < 0:
                        ...
                        $ the_person.change_obedience(-the_person.opinion.drinking_cum, max_amount = 160)
                        $ the_person.change_love(the_person.opinion.drinking_cum)
                        "[the_person.possessive_title!c] seems appalled by the idea, but obeys and gets onto her knees."
                    else:
                        "You struggle to hold back your orgasm while [the_person.title] obeys and gets onto her knees."
        ...
        if cum_on_floor_instead:
            ...
            $ the_person.draw_person(position = "kneeling1")
            if the_person.opinion.drinking_cum > 0:
                "[the_person.possessive_title!c] looks up at you and licks her lips."
                the_person "Give me all of that hot cum, I'm going to guzzle it down for you!"
                $ the_person.discover_opinion("drinking cum")
            else:
                "[the_person.possessive_title!c] looks up at you from her knees, mouth open and ready for her load."
            ...
            if the_choice == "Cum in her mouth":
                ...
                if the_person.opinion.drinking_cum > 0 or the_person.effective_sluttiness() >= 60:
                    $ play_swallow_sound()
                ...
                "You feel your tip glide against the very back of her throat, and the feeling makes you cum."
                $ demands_money = False
                if the_person.effective_sluttiness() + (10 * the_person.opinion(("drinking cum", "being submissive"))) < 40:
                    if the_person.oral_sex_skill < 4:
                        ...
                        $ the_person.cum_in_mouth()
                        $ the_person.draw_person(position = "kneeling1")
                        "[the_person.possessive_title!c] has to close her eyes and focus as you dump your load down her throat."
                        $ play_swallow_sound()
                    ...
                    $ the_person.change_stats(love = -5 + (2 * the_person.opinion(("drinking cum","being submissive"))),
                        obedience = -5 + (2 * the_person.opinion(("drinking cum", "being submissive"))))
                    "She shakes her head angrily."
                    the_person "No, I wasn't into it!"

                    if not the_person.is_submissive and for_pay:
                        $ demands_money = True
                else:
                    if the_person.oral_sex_skill < 4:
                        $ play_gag_sound()
                        ...
                        $ play_gag_sound()
                        "[the_person.possessive_title!c] gags and chokes, blowing bubbles of spit and cum out her nose and around the base of your shaft."
                        $ play_swallow_sound()
                        ...
                        $ play_swallow_sound()
                        "[the_person.possessive_title!c] takes your load, gulping it as fast as you can give it to her."
                        "Soon enough you're finished, and you take your hand off of the back of her head."
                        "She lingers for a moment, then she pulls her head back with slow deliberateness. Her tongue trails across your sensitive tip before she breaks contact entirely."
                ...
                if demands_money and for_pay: #Demands extra cash for the stunt you just pulled.
                    $ bribe_cost = 100
                    if the_person.opinion(("drinking cum","being submissive")) < 0:
                        $ bribe_cost = 200
                    ...
                    menu:
                        "Pay her\n{menu_red}Costs: $[bribe_cost]{/menu_red}" if mc.business.has_funds(bribe_cost):
                            ...
                            $ mc.business.change_funds(-bribe_cost, stat = "Strippers")
                            $ the_person.change_obedience(1 - the_person.opinion.taking_control, max_amount = 160) #If she likes taking control she may actually lose Obedience by demanding a bribe.
                        ...
                        "Refuse":
                            ...
                            $ the_person.change_stats(happiness = -10 + 2 * the_person.opinion.being_submissive, love = -5 + the_person.opinion.being_submissive, obedience = -5 + the_person.opinion.being_submissive, slut = the_person.opinion.being_submissive, max_slut = 50)
