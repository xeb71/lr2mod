...
screen colour_selector(allow_none = False, title = None, show_alpha = False):
    ...
    frame:
        ...
        vbox:
            ...
            use colour_ui(current_r, current_g, current_b, current_a, show_alpha = show_alpha)
            hbox:
                xanchor 0.5
                xalign 0.5
                textbutton "Confirm Colour":
...
screen colour_ui(current_r, current_g, current_b, current_a, background_colour = None, show_alpha = True): # Provides a reusable UI for selecting colours. Stores RGBA values in variables that can be used by other screens for something.
    ...
    frame:
        ...
        vbox:
            ...
            grid 10 2:
                ...
                xalign 0.5
                xanchor 0.5
                for count, a_colour in builtins.enumerate(persistent.colour_palette[0:20]):
