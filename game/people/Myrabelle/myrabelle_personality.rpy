...
label myrabelle_greetings(the_person):
    ...
    if the_person.love < 0:
        ...
        the_person "Oh hey! It's my favourite sponsor! What can I do for you?"
    else:
...
label myrabelle_sex_responses_vaginal(the_person):
    if the_person.energy < 10:
        call low_energy_sex_responses_vaginal(the_person) from _call_low_energy_sex_responses_vaginal_6
        return
...
label myrabelle_sex_responses_anal(the_person):
    if the_person.energy < 10:
        call low_energy_sex_responses_anal(the_person) from _call_low_energy_sex_responses_anal_6
        return
...
label myrabelle_climax_responses_vaginal(the_person):
    ...
    if the_person.sluttiness > 70:
        if the_person.arousal_perc > 120:
            the_person "Ah yes! Pound that slutty little pussy hard! I'm going to..."
        elif the_person.is_submissive:
            the_person "Oh god, fuck your little cock slave hard! Oh god, [the_person.mc_title], I'm cumming..."
        else:
...
label myrabelle_climax_responses_anal(the_person):
    ...
    if the_person.sluttiness > 80:
        if the_person.arousal_perc > 120:
            the_person "Oh yes [the_person.mc_title], pound my ass and make me cum!"
        elif the_person.is_submissive:
            the_person "Oh god, keep punishing my perky ass! It deserves a good fucking!"
        else:
            the_person "I'm going to cum! Fuck my ass and make me cum!"
        "Her rectum tightens as she squeals with pleasure."
    else:
...
label myrabelle_clothing_review(the_person):
    ...
    if the_person.should_wear_uniform:
        ...
        if the_person.sluttiness > 40:
            ...
            the_person "My clothes are a mess! Just wait a sec, so I can fix that."
...
label myrabelle_flirt_response_employee_uniform_low(the_person):
...
label myrabelle_flirt_response_employee_uniform_mid(the_person):
    if the_person.judge_outfit(the_person.outfit):
...
label myrabelle_flirt_response_low1(the_person):
    if the_person.has_significant_other:
        ...
        the_person "You'll have to beat me at my favourite game though."
    return
...
label myrabelle_flirt_response_mid1(the_person):
    $ mc.change_locked_clarity(10)
    ...
    if mc.location.person_count > 1 and the_person.effective_sluttiness("kissing") < (25 - (5*the_person.opinion.public_sex)):
        ...
        menu:
            "Find somewhere more quiet\n{menu_yellow}[mc.location.interruption_info_text]{/menu_yellow}":
                ...
                call mc_change_to_private_location(the_person) from _call_mc_change_to_private_location_myrabelle_flirt_response_high_2
                ...
                call mc_restore_original_location(the_person) from _call_mc_restore_original_location_myrabelle_flirt_response_high_2
        ...
        menu:
            "Kiss her":
                ...
                $ the_person.draw_person(position = "kissing", special_modifier = "kissing")
                "You close the final gap and kiss her. She returns the kiss immediately, leaning her body against yours."
                call mc_move_to_private_location(the_person) from  _call_mc_move_to_private_location_myrabelle_flirt_response_high
                call fuck_person(the_person, start_position = kissing, private = _return, skip_intro = True) from _call_fuck_myrabelle_48
                $ the_person.call_dialogue("sex_review", the_report = _return)
                call mc_restore_original_location(the_person) from _call_mc_restore_original_location_myrabelle_flirt_response_high
        ...
        if the_person.effective_sluttiness("kissing") < (25 - (5*the_person.opinion.public_sex)):
            ...
            menu:
                "Find somewhere more quiet\n{menu_yellow}[mc.location.interruption_info_text]{/menu_yellow}":
                    ...
                    call mc_change_to_private_location(the_person) from _call_mc_change_to_private_location_myrabelle_flirt_response_girlfriend
                    $ the_person.draw_person(position = "kissing", special_modifier = "kissing")
                    ...
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    call mc_restore_original_location(the_person) from _call_mc_restore_original_location_myrabelle_flirt_response_girlfriend
            ...
            menu:
                "Make out":
                    ...
                    call mc_move_to_private_location(the_person) from _call_mc_move_to_private_location_myrabelle_flirt_response_girlfriend_2
                    call fuck_person(the_person, start_position = kissing, private = False, skip_intro = True) from _call_fuck_myrabelle_72
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    call mc_restore_original_location(the_person) from _call_mc_restore_original_location_myrabelle_flirt_response_girlfriend_2
    ...
    if mc.location.person_count > 1: #There are other people around, she's nervous about people finding out what you're doing.
        if (the_person.opinion.cheating_on_men *15) + the_person.effective_sluttiness() > 50: #SHe's turned on by flirting in public or doesn't think anything is wrong with it
            ...
            menu:
                "Find somewhere more quiet\n{menu_yellow}[mc.location.interruption_info_text]{/menu_yellow}":
                    ...
                    call mc_change_to_private_location(the_person) from _call_mc_change_to_private_location_myrabelle_flirt_response_affair
                    ...
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    call mc_restore_original_location(the_person) from _call_mc_restore_original_location_myrabelle_flirt_response_affair
        ...
        menu:
            "Make out":
                ...
                call mc_change_to_private_location(the_person) from _call_mc_move_to_private_location_myrabelle_flirt_response_affair_2
                call fuck_person(the_person, private = _return, start_position = kissing, skip_intro = True) from _call_fuck_myrabelle_75
                $ the_person.call_dialogue("sex_review", the_report = _return)
                call mc_restore_original_location(the_person) from _call_mc_restore_original_location_myrabelle_flirt_response_affair_2
            "Just flirt":
...
label myrabelle_cum_mouth(the_person):
    if the_person.obedience > 180:
        if the_person.sluttiness > 60 and the_person.opinion.drinking_cum > 0:
        ...
        if the_person.sluttiness > 80 and the_person.opinion.drinking_cum > 0:
        ...
        if the_person.has_tits_cum:
            if the_person.tits_visible:
                the_person "And my tits are covered in your cum."
            else:
                the_person "And now I have to wash my [the_person.outfit.get_upper_top_layer.display_name] too."
    return
    ...
    if mc.condom: #TODO: All of the cum-drunk stuff
        ...
        if the_person.wants_creampie:
            ...
            if not the_person.on_birth_control: #You need to pull out, I'm not on the pill!
                ...
                the_person "Oh baby, perhaps you should pull out, just in case!"
    return
    ...
    if the_person.wants_creampie:
        if the_person.knows_pregnant:
            ...
            if the_person.has_significant_other:
                ...
                the_person "I just wish my [the_person.so_title] had your skills [the_person.mc_title]."
            else:
                the_person "Oh yes... right there... fill me up..."
                "She sighs happily as you cum inside her."
        ...
        if the_person.knows_pregnant:
            the_person "Ah fuck, you came inside me, at least I can't get more pregnant than I already am."
...
label myrabelle_cum_anal(the_person):
    if the_person.sluttiness > 75 or the_person.opinion.anal_creampies > 0:
        $ pronoun = person_body_shame_string(the_person.body_type, "gamer's butthole")
        the_person "Oh god yes, cum inside my ass! Fill up that [pronoun]."
    elif the_person.opinion.anal_creampies < 0:
        the_person "Oh fuck, not inside my ass! It will leak all day!"
    else:
...
label myrabelle_sex_watch(the_person, the_sex_person, the_position):
    ...
    if renpy.random.randint(0, 1) == 0:
        ...
        call watcher_position_comment(the_person, the_sex_person, the_position) from _call_watcher_position_comment_myrabelle_sex_watch
...
label myrabelle_date_seduction(the_person):
    if the_person.is_girlfriend:
        ...
        elif the_person.effective_sluttiness(["sucking_cock"]) > 40 and the_person.opinion.giving_blowjobs > 0 and myra_finish_blowjob_training():
...
label myrabelle_sex_take_control(the_person):
    if the_person.has_cum_fetish:
        the_person "Ha! Fuck that! You are going to give me your hot spunk, one way or another."
...
label myrabelle_sex_beg_finish(the_person):
    the_person "Wait [the_person.mc_title], please, just fuck me... just let me cum!"
    return
...
label myrabelle_sex_review(the_person, the_report):
    ...
    # special condition - you fucked her brains out
        ...
        call sex_review_trance(the_person) from _call_sex_review_trance_myrabelle_sex_review
    ...
    #No special conditions, just respond based on how orgasmed and how slutty the position was.
        ...
        the_person "Oh god, I'm so tired... next time I'll make sure to be prepared."
        mc.name "Of course you will."
...
label myrabelle_kissing_taboo_break(the_person):
    if the_person.effective_sluttiness() >= 30:
        ...
        mc.name "I didn't realise you wanted to. Come here."
    else:
...
label myrabelle_vaginal_sex_taboo_break(the_person): #TODO: add a "I don't do anal""you do for me" style taboo break
    if the_person.effective_sluttiness() >= 60:
        the_person "Wow, it's about fucking time! Let's do it!"
...
label myrabelle_condomless_sex_taboo_break(the_person):
    if the_person.knows_pregnant:
        ...
        if the_person.on_birth_control:
            the_person "I'm taking the pill, so it should be fine? Maybe pull out, just in case."
            $ the_person.update_birth_control_knowledge()
        elif the_person.opinion.creampies > 0:
