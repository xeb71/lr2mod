...
label aunt_sex_accept(the_person, the_position):
    if the_person.sluttiness > 70:
        if the_person.obedience < 100:
            the_person "This is our little secret, no one needs to know, especially [mom.name], okay?"
        else:
            if the_position.skill_tag == "Foreplay":
                the_person "Kissing your own aunt, [the_person.mc_title], you're such a pervert."
            elif the_position.skill_tag == "Oral":
                if "getting head" in the_position.opinion_tags:
                    the_person "Oh yes, come here and take care of [the_person.title]."
                else:
                    the_person "Come here, let aunty take care of your nice hard cock."
            elif the_position.skill_tag == "Vaginal":
                the_person "Oh yes baby, I need you to fuck your auntie's slutty pussy senseless."
            else:
                the_person "Come here and fuck your auntie's tight ass like there's no tomorrow."
    else:
        if the_person.love < 40:
            the_person "Okay, lets try it. Just don't tell [mom.name]."
        else:
            if the_position.skill_tag == "Foreplay":
                the_person "Oh yes, come here and kiss me!"
            elif the_position.skill_tag == "Oral":
                the_person "Come play with [the_person.title]."
            else:
                if the_person.has_taboo(["vaginal_sex", "anal_sex"]):
                    the_person "Oh my, I don't know what would my sister say."
                else:
                    the_person "Hmm, again... alright, just don't tell my sister."
    return

label aunt_sex_obedience_accept(the_person):
    if the_person.sluttiness > 70:
        the_person "I shouldn't do this with my nephew. I know I should say no..."
        if the_person.has_taboo(["vaginal_sex", "anal_sex"]):
            the_person "But just once couldn't hurt, right?"
        else:
            the_person "But just one more time couldn't hurt, right?"
    else:
        if the_person.obedience > 180:
            the_person "I... We really shouldn't... it's only for your education."
        else:
            the_person "How does this keep happening [the_person.mc_title]? You know I care for you as lot, but we shouldn't be doing this..."
            "[the_person.possessive_title!c] looks away, conflicted."

    the_person "You just have to promise me my sister will never finds out. Nobody can know..."
    return

label aunt_sex_gentle_reject(the_person):
    if the_person.sluttiness > 50:
        the_person "We can't, I'm you aunt. Let's start out with something a little more tame."
    else:
        the_person "I... we can't do that [the_person.mc_title]. I'm your aunt; there are lines we just shouldn't cross."
    return

label aunt_sex_angry_reject(the_person):
    if the_person.sluttiness < 20:
        the_person "Oh god, what did you just say? I'm family, I told you it couldn't happen again!"
    else:
        the_person "What? Oh god, I... I'm your aunt! Don't make this harder than it is."
        "[the_person.possessive_title!c] turns away from you."
        the_person "You should go. I should have known it was a mistake."
    return
...
label aunt_sex_review(the_person, the_report):
    ...
    # special condition - you fucked her brains out
        ...
        if used_obedience:
            ...
            "[the_person.possessive_title!c] seems a little embarrassed, but hides it well."
        else:
        ...
        call sex_review_trance(the_person) from _call_sex_review_trance_aunt_sex_review
    ...
    #No special conditions, just respond based on how orgasmed and how slutty the position was.
        ...
        the_person "I'm sorry, [the_person.mc_title], but I'm just too tired."
        mc.name "No problem [the_person.fname], we can do this another time."
...
label aunt_flirt_response_low1(the_person):
    the_person "[the_person.mc_title], you shouldn't say that to your aunt. What if somebody heard that."
    mc.name "Can't I compliment my aunt on her trendy clothing choices?"
    the_person "Ah, well, do you really like it?"
    mc.name "Absolutely, you look fantastic."
    $ mc.change_locked_clarity(5)
    "She smiles and laughs."
    return
...
label aunt_flirt_response_mid1(the_person):
    $ mc.change_locked_clarity(10)
    if mc.location.person_count > 1:
        "[the_person.possessive_title!c] smiles, then glances around quickly."
        the_person "Not so loud, [the_person.mc_title], people might get the wrong impression."
    the_person "Thanks, do your really think your auntie looks amazing in this outfit?"
    mc.name "Definitely, how about you and me go and grab a coffee sometime?"
    the_person "Why not, I can go and grab a coffee with my nephew. Just give me a call."
    the_person "Perhaps we can go shopping for new outfits afterwards, I do like your input."
    return
        ...
        if the_person.effective_sluttiness() > (25 - the_person.opinion.incest*5): # High sluttiness flirt
            ...
            menu:
                ...
                "Just flirt":
                    ...
                    "[the_person.possessive_title!c] grabs her own tits and jiggles them up and down, alternating between her left and right boob."
        ...
        if the_person.effective_sluttiness() > (25 - the_person.opinion.incest*5): #She's slutty, but you need to find somewhere private so people don't find out.
            ...
            menu:
                "Find somewhere more quiet\n{menu_yellow}[mc.location.interruption_info_text]{/menu_yellow}":
                    ...
                    "After a pause she nods and follows after you."
                    call mc_change_to_private_location(the_person) from _call_mc_change_to_private_location_aunt_flirt_response_high
                    if the_person.has_taboo("kissing"):
                        $ the_person.call_dialogue("kissing_taboo_break")
                        $ the_person.break_taboo("kissing")
                        "You lean in and kiss her. She hesitates for a moment before gently pressing herself against your body."
                    ...
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    call mc_restore_original_location(the_person) from _call_mc_restore_original_location_aunt_flirt_response_high
    ...
    if mc.condom:
        if the_person.wants_creampie and not the_person.has_taboo("condomless_sex"): #TODO: FIgure out we want any more requirements for this to fire.
            if the_person.knows_pregnant:
                ...
                the_person "Cum inside me? I'm on the pill, and it would feel so good!"
            else:
                the_person "Oh fuck... Do you want to take the condom off?"
                "She moans desperately."
                $ the_person.update_birth_control_knowledge()
                the_person "I don't even care if you get me pregnant, I just want to feel all of your cum inside me!"
...
label aunt_cum_condom(the_person):
    if the_person.on_birth_control:
        ...
        "[the_person.possessive_title!c] stammers for a moment."
...
label aunt_cum_vagina(the_person):
    if the_person.wants_creampie:
        ...
        if the_person.on_birth_control:
            ...
            $ the_person.update_birth_control_knowledge()
            "[the_person.possessive_title!c] sighs unhappily."
            the_person "I guess the damage is already done... Next time you're going to have to wear a condom. This can't keep happening."
    return

label aunt_cum_anal(the_person):
    if the_person.sluttiness > 75 or the_person.opinion.anal_creampies > 0:
        the_person "Oh yes, fill up auntie's ass! I want you to give it all to me!"
    elif the_person.opinion.anal_creampies < 0:
        the_person "Oh fuck, pull out nephew, not in my ass."
    else:
        the_person "Oh lord, my nephew is cumming in my ass!"
    return

label aunt_sex_take_control(the_person):
    if the_person.has_cum_fetish:
        the_person "Just sit back [the_person.mc_title], your auntie needs more of your hot seed."
    elif the_person.arousal_perc > 60:
        the_person "[the_person.mc_title], relax... Auntie will make sure you have a good time."
    else:
        the_person "Oh [the_person.mc_title], you have made your aunt really horny. Just lie down and let me make you feel good."
    return

label aunt_sex_beg_finish(the_person):
    the_person "Wait [the_person.mc_title], I'm so close! Please, make your auntie cum!"
    return
...
label aunt_kissing_taboo_break(the_person):
    ...
    the_person "It's very confusing for a young man. I suppose..."
    "[the_person.possessive_title!c] sighs. You can see her resolve breaking down."
...
label aunt_touching_penis_taboo_break(the_person):
    if the_person.love > 30:
        ...
        "She looks down at your hard cock, {height_system} from her hand. For a moment she seems entranced by it."
        ...
        "[the_person.possessive_title!c] is quiet for a moment, her eyes are still locked on your dick."
        ...
        "[the_person.possessive_title!c] doesn't look away for long, her eyes drifting back down to your hard cock, {height_system} from her hand."
...
label aunt_sucking_cock_taboo_break(the_person):
    ...
    if the_person.love > 40:
        "[the_person.possessive_title!c] covers her mouth and looks away, suddenly embarrassed."
    ...
    "[the_person.possessive_title!c] shakes her head and laughs self-consciously."
...
label aunt_anal_sex_taboo_break(the_person):
    ...
    if the_person.love > 60:
        ...
        "[the_person.possessive_title!c] seems unsure, but you press on anyways."
        ...
        if the_person.has_taboo("vaginal_sex"):
            mc.name "Come on [the_person.title], I'm so turned on. Can I slide into your pussy instead?"
        ...
        "[the_person.possessive_title!c] seems unsure, but you press on."
        mc.name "Have you ever tried it before?"
...
label aunt_creampie_taboo_break(the_person):
    ...
    "[the_person.possessive_title!c] gasps, then is silent for a moment."
    if the_person.wants_creampie:
        ...
        if the_person.on_birth_control:
            ...
            the_person "It felt good for me too, but I know it shouldn't."
            ...
            mc.name "[the_person.possessive_title!c], calm down. You probably aren't going to get pregnant, and nobody needs to know what we're doing."
            "She takes a deep, slow breath as she tries to calm herself."
