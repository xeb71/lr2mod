...
label mom_sex_responses_foreplay(the_person):
    if the_person.arousal_perc < 45:
        ...
        if the_person.sluttiness > 50:
            ...
            "[the_person.possessive_title!c] whispers to herself under her breath as she tries not to moan too loudly."
...
label mom_sex_responses_oral(the_person):
    if the_person.arousal_perc < 45:
        if the_person.sluttiness > 50:
            "[the_person.possessive_title!c] quivers underneath your tongue."
        ...
        if the_person.sluttiness > 50:
            ...
            "[the_person.possessive_title!c]'s calm facade begins to break down, as she moans your name."
            the_person "Oh [the_person.mc_title]..."
    else:
        if the_person.sluttiness > 50:
...
label mom_sex_responses_vaginal(the_person):
    if the_person.energy < 10:
        call low_energy_sex_responses_vaginal(the_person) from _call_low_energy_sex_responses_vaginal_3
        return
    ...
    if the_person.arousal_perc < 45:
        if the_person.sluttiness > 50:
            ...
            "[the_person.possessive_title!c]'s happy moans as you slide into her betray her real feelings."
    elif the_person.arousal_perc < 60:
        if the_person.sluttiness > 50:
...
label mom_sex_responses_anal(the_person):
    if the_person.energy < 10:
        call low_energy_sex_responses_anal(the_person) from _call_low_energy_sex_responses_anal_3
        return
...
label mom_clothing_reject(the_person):
    if the_person.obedience > 140:
        ...
        if the_person.sluttiness > 60:
            the_person "I... [the_person.mc_title], you don't think a woman of my... experience could get away wearing this, do you?"
            "[the_person.possessive_title!c] laughs and shakes her head."
            the_person "No, risqué stuff like this should be worn by people your sister's age!"
        else:
            the_person "[the_person.mc_title]! I'm your mother, I can't go walking around in something like that!"
            "[the_person.possessive_title!c] shakes her head and scoffs at the idea."
    return
...
label mom_clothing_review(the_person):
    if the_person.outfit.cum_covered:
        if (the_person.sluttiness > 40 and the_person.opinion.being_covered_in_cum >=0) or the_person.opinion.being_covered_in_cum > 0:
            ...
            "[the_person.possessive_title!c] quickly wipes away the most obvious splashes of cum on her body."
        else:
            the_person "I need to clean all of your... semen off of me. Let me know if I've missed any."
            "[the_person.possessive_title!c] starts to wipe up all the cum on her."
...
label mom_grope_body_reject(the_person):
    if the_person.effective_sluttiness("touching_body") < 5: #Fail point for touching shoulder
        ...
        if the_person.love > 20:
            ...
            the_person "Oh, it's okay [the_person.mc_title]. My shoulders feel fine."
        ...
        if the_person.obedience < 100:
            ...
            if the_position.skill_tag == "Foreplay":
                ...
                if not had_family_threesome():
                    ...
                    the_person "Oh yes baby, I want you to make mommy cum hard."
    else:
        if the_person.love < 40:
            the_person "Okay, let's try it. I just hope this brings us closer together as mother and son."
        else:
            if the_position.skill_tag == "Foreplay":
...
label mom_seduction_response(the_person):
    if the_person.obedience > 180:
        if the_person.sluttiness > 50:
            the_person "Do you need some personal attention [the_person.mc_title]? I know how stressed you can get."
        else:
...
label mom_flirt_response_low(the_person):
    ...
    "[the_person.possessive_title!c] opens her arms up and gives you a warm, motherly hug."
    return

label mom_flirt_response_low1(the_person):
    the_person "Oh, thank you [the_person.mc_title], you always know how to cheer me up."
    $ mc.change_locked_clarity(5)
    "[the_person.possessive_title!c] give you a kiss on your cheek."
    return
...
label mom_flirt_response_mid(the_person):
    if the_person.effective_sluttiness("underwear_nudity") < 20: #Not very slutty, so it must be high love.
        ...
        "[the_person.possessive_title!c] gives you a quick, motherly hug."
        ...
        the_person "I don't have the same body I did when I was young though. I've put on a few {weight_system} since then."
        mc.name "If you did you've put it in all the right places. Turn around for me."
        "[the_person.possessive_title!c] raises an eyebrow and hesitates, then shrugs and turns around for you."
        ...
        "[the_person.possessive_title!c] turns around and slaps you lightly on the shoulder, smiling and blushing."
        the_person "[the_person.mc_title]! Stop it, you're making me blush!"
    return

label mom_flirt_response_mid1(the_person):
    $ mc.change_locked_clarity(10)
    ...
    the_person "I guess so, I can go for a coffee with my son."
    return
        ...
        if the_person.effective_sluttiness() > (25 - the_person.opinion.incest*5): #She's slutty, but you need to find somewhere private so people don't find out.
            ...
            menu:
                "Find somewhere more quiet\n{menu_yellow}[mc.location.interruption_info_text]{/menu_yellow}":
                    ...
                    call mc_change_to_private_location(the_person) from _call_mc_change_to_private_location_mom_flirt_response_high
                    ...
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    call mc_restore_original_location(the_person) from _call_mc_restore_original_location_mom_flirt_response_high
...
label mom_cum_mouth(the_person):
    if the_person.obedience > 180:
        if the_person.sluttiness > 50:
            ...
            the_person "I... Oh I'm not sure I'm going to be able to get used to that. I'll try for you though [the_person.mc_title]."
    else:
        if the_person.sluttiness > 70:
...
label mom_cum_vagina(the_person):
    if the_person.wants_creampie:
        if the_person.knows_pregnant:
            ...
            the_person "Give mommy your cum, I want every last drop inside me! Try and get mommy pregnant!"
        ...
        if not the_person.on_birth_control:
            ...
            the_person "Sweety, I wanted you to pull out. Now I need to have a shower just to try and clean out all of this cum inside me."
...
label mom_cum_anal(the_person):
    if the_person.sluttiness > 75 or the_person.opinion.anal_creampies > 0:
        the_person "Cum inside mommy's ass! I want you to give it all to me!"
    elif the_person.opinion.anal_creampies < 0:
        the_person "Oh no, not inside baby, not in my ass."
    else:
        the_person "Oh lord, my son is filling up my ass!"
    return
...
label mom_sex_watch(the_person, the_sex_person, the_position):
    ...
    the_person "Come on darling, show your mommy what you're made of."
...
label mom_being_watched(the_person, the_watcher, the_position):
    ...
    if the_person.sluttiness >= the_position.slut_cap and the_watcher.sluttiness >= the_position.slut_cap:
        ...
        the_person "Don't listen to [title]. I'm just taking care of my son, any way he needs!"

    elif the_person.sluttiness >= the_position.slut_cap and the_watcher.sluttiness < the_position.slut_cap:
        #She's super slutty and encourages the watcher to be slutty.
        $ the_person.change_arousal(1)
        the_person "[the_person.mc_title], I love you so much. I hope [title] understands that."
        "[the_person.title] seems turned on by [title] watching you and her [the_position.verb]."
        ...
        the_person "[the_person.mc_title], we shouldn't be doing this. Not here. What if people recognise us? What if they talk?"
        ...
        the_person "I'm glad you're so supportive."
...
label mom_climax_responses_oral(the_person):
    if the_person.sluttiness > 70:
        ...
        "[the_person.possessive_title!c] closes her eyes and moans passionately."
    else:
...
label mom_sex_take_control(the_person):
    if the_person.has_cum_fetish:
        the_person "Just sit back [the_person.mc_title], mommy needs her little boy to fill her up."
    elif the_person.arousal_perc > 60:
        ...
        the_person "Oh [the_person.mc_title], you can't get a woman all worked up then just walk away. Here, let me take care of both of us."
    return

label mom_sex_beg_finish(the_person):
    the_person "Wait [the_person.mc_title], you can't stop now, I'm so close! Please, please help your mother cum!"
    return
...
label mom_sex_review(the_person, the_report):
    ...
    # special condition - you fucked her brains out
        ...
        call sex_review_trance(the_person) from _call_sex_review_trance_mom_sex_review
    ...
    #No special conditions, just respond based on how orgasmed and how slutty the position was.
        ...
        if the_person.effective_sluttiness() > comment_position.slut_cap: #She's sluttier than the position
            ...
            the_person "[the_person.possessive_title!c] sighs, obviously relieved that you're finished."
        ...
        the_person "I'm sorry, [the_person.mc_title], I'm too tired."
...
label mom_kissing_taboo_break(the_person):
    ...
    if the_person.event_triggers_dict.get("kissing_revisit_count", 0) == 0:
        ...
        "[the_person.possessive_title!c] struggles with her feelings for a moment, then nods meekly."
...
label mom_touching_penis_taboo_break(the_person): #TODO: Should this taboo have a revisit?
    ...
    if the_person.love > 30: # Love variant
        ...
        "[the_person.possessive_title!c] looks you in the eyes again and laughs self-consciously."
...
label mom_touching_vagina_taboo_break(the_person):
    if the_person.event_triggers_dict.get("oral_revisit_count", 0) == 0:
        ...
        if the_person.love > 30:
            ...
            "[the_person.possessive_title!c] takes a long moment to think, but you can see her resistance is breaking down."
...
label mom_sucking_cock_taboo_break(the_person):
    ...
    if the_person.event_triggers_dict.get("oral_revisit_count", 0) == 0:
        if the_person.love > 40:
            ...
            "[the_person.possessive_title!c] grabs your head and kisses you passionately. You wrap your arms around her reciprocate."
            ...
            "[the_person.possessive_title!c] stares intently into your eyes as she listens to you."
...
label mom_anal_sex_taboo_break(the_person):
    if the_person.event_triggers_dict.get("anal_revisit_count", 0) == 0:
        if the_person.love > 60:
            ...
            "[the_person.possessive_title!c] shakes her head sheepishly."
            ...
            the_person "You mean you want to try anal? Right now?"
            if the_person.has_taboo("vaginal_sex"):
        ...
        mc.name "Then what am I supposed to do [the_person.title]? You got me so hard and I need you to take care of me."
...
label mom_bare_tits_taboo_break(the_person, the_clothing):
    ...
    "She sighs and rolls her eyes."
    the_person "I suppose it's normal for a man your age to be interested in a woman's breasts..."
...
label mom_creampie_taboo_break(the_person):
    if the_person.wants_creampie:
        "[the_person.possessive_title!c] sighs happily, then is quiet for a moment."
        ...
        if the_person.knows_pregnant:
            the_person "You shouldn't be cumming inside your mother, even if she gets a little too excited and starts to ask for it."
        ...
        if the_person.on_birth_control:
            ...
            "[the_person.possessive_title!c] is silent for a few long moments."
