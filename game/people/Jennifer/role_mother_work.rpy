...
label mom_work_promotion_one(the_person): #Mom is up for a promotion and asks you for help. You can tell her to get it on her merits (She doesn't) or to dress up for it.
    # Triggered when Mom has 35 sluttiness, 25 Love, and at least 120 Obedience
    ...
    menu:
        "Take advantage of your womanly charms":
            ...
            mc.name "If you're the only woman then you're the only person who can bring a woman's perspective, and a woman's charm."
            the_person "That is one way of looking at... Wait, what do you mean a \"woman's charm\", exactly?"
            ...
            the_person "Would you help me pick out my interview outfit? You can give me a man's perspective on it."
            ...
            menu:
                "Help her pick out an outfit":
                    ...
                    if not mc.is_at(mom_bedroom):
                        ...
                        "You walk over and start digging around in her wardrobe."
    ...
    $ the_person.apply_planned_outfit() # If you've been trying out an outfit she changes back into it.
...
label mom_work_promotion_outfit_create(the_person):
    call outfit_master_manager(wardrobe = mom_business_wardrobe, slut_limit = the_person.sluttiness + 15, show_overwear = False, show_underwear = False, start_mannequin = the_person) from _call_outfit_master_manager_6
    ...
    if interview_outfit:
        ...
        if not the_person.is_naked:
            ...
            "She starts to put on your outfit."

        $ the_person.apply_outfit(interview_outfit, show_dress_sequence = True)
        ...
        menu:
            "Go with it" if acceptable:
                ...
                $ mom_business_wardrobe.add_outfit(interview_outfit.get_copy())
                $ the_person.event_triggers_dict["mom_work_promotion_outfit"] = interview_outfit.name
...
label mom_work_promotion_one_before(the_person): # She tells you in the morning that she's going to her interview.
    ...
    if the_person.effective_sluttiness("kissing") > 30:
        ...
        "[the_person.possessive_title!c] steps close to you and leans towards you."
        $ mc.change_locked_clarity(10)
    ...
    $ clear_scene()
    $ the_person.change_location(mom_offices)
...
label mom_work_promotion_one_report(the_person): # She tells you how her interview went.
    if the_person.event_triggers_dict.get("mom_work_promotion_outfit_slutty", False):
        ...
        the_person "The interview board seems very receptive to my points about bringing a woman's viewpoint onto the team, too!"
        $ mc.change_locked_clarity(5)
        $ the_person.draw_person(position = "kissing", emotion = "happy")
        "She gives you a tight hug."
        $ the_person.change_love(3)
        $ the_person.draw_person(emotion = "happy")
        the_person "Thank you for all the help and encouragement. You're such a sweetheart."
...
label mom_work_promotion_two_intro(the_person): # She asks you to help her prepare for her one-on-one interview.
    ...
    $ mom.progress.lust_step = 2
    "There's a soft knock at your door as you are getting ready for bed."
    the_person "It's me, can I come in?"
    mc.name "Come on in, [the_person.title]."
    $ the_person.draw_person()
    "[the_person.possessive_title!c] opens the door and leans in."
...
label mom_work_promotion_two_prep(the_person):
    ...
    $ the_person.draw_person(position = "walking_away")
    "[the_person.possessive_title!c] stands up and turns towards her wardrobe as she starts stripping down."

    $ the_person.strip_full_outfit(strip_feet = True, strip_accessories = True, position = "walking_away")
    $ mc.change_locked_clarity(10)
    $ the_target = the_person.event_triggers_dict.get("mom_work_promotion_outfit", "Empty")
    ...
    menu:
        "Suggest something sexier" if not the_person.event_triggers_dict.get("mom_work_promotion_outfit_slutty", False) and mom_business_wardrobe.has_outfit_with_name("business_slutty"):
            ...
            $ the_person.apply_outfit(mom_business_wardrobe.get_outfit_with_name("business_slutty"), show_dress_sequence = True)
            $ mc.change_locked_clarity(10)
            $ the_person.draw_person(emotion = "happy")
        ...
        "Suggest something else":
            mc.name "Let's try something else this time, we want to make sure you get that promotion."
            the_person "If you think we can improve, we should try it."
            "You walk up to her closet and start to put together a new outfit."
            call mom_work_promotion_outfit_create(the_person) from _call_mom_work_promotion_outfit_create_two_prep
            $ mc.change_locked_clarity(10)

        "That outfit is fine" if mom_business_wardrobe.has_outfit_with_name(the_target):
    ...
    $ the_person.draw_person(position = "sitting")
    "[the_person.possessive_title!c] sits back down on the bed and crosses her legs."
    ...
    menu:
        "Be slutty": #She gets promoted to be her bosses "secretary"
            ...
            $ mc.change_locked_clarity(5)
            "[the_person.possessive_title!c] puffs out her chest a little bit."
            ...
            "[the_person.possessive_title!c] takes a pen from her bedstand and drops it on the floor in front of her."
            ...
            $ the_person.draw_person(position = "kissing")
            "[the_person.possessive_title!c] gives you a warm hug."
        ...
        "Be friendly": #She gets promoted to be her bosses "secretary" if she's dressed slutty
        ...
        "Be professional": #She doesn't get any sort of promotion
            ...
            "[the_person.possessive_title!c] grabs a note pad from her bedstand and starts reading through it."
...
label mom_work_promotion_two_report(the_person): #TODO: Hook this up as an on_room or maybe a mandatory event
    ...
    if the_person.event_triggers_dict.get("mom_work_secretary_promotion", False): #Promotion, setting her up to be turned into the office slut.
        ...
        $ the_person.draw_person()
        "She lets you hold her for a few moments, then she steps back and smiles. It seems a little more sincere this time."
    ...
    "You think about [the_person.possessive_title] and her job."
    "It would be nice to have your OWN personal secretary!"
    "What would that even require? You imagine just a desk and a computer terminal, but setup in front of your office?"
    "You make a mental to note to look into it... you could probably just move one of your HR employees over."
    "Surely they could still do a majority of their HR work from your office?"
    "And having a personal secretary could come with all kinds of additional... benefits..."
    "You can imagine sitting in your office, filling out work emails while your very own personal secretary is under your desk, servicing you orally..."
    $ mc.change_locked_clarity(50)
    "Yeah... you should definitely look into hiring one!"
    $ mc.business.event_triggers_dict["personal_secretary_policy_avail"] = True
    return
        ...
        "Ask about her day":
            ...
            if slut_level == 1: #Just took her promotion and was asked to be a little slutty
                ...
                if random_result == 0: # E) Gives her boss a blowjob when he was unhappy with his lunch order
                    ...
                    if the_person.effective_sluttiness("sucking_cock") > the_person.love: #She doesn't care about you enough to hide what she's doing #TODO: This should also consider if she's in a committed relationship with you
                    ...
                    the_person "He said it was for a clerk position, but I think he might have been looking people to replace me."
            ...
            elif slut_level == 3: # Sex condom phase
                #TODO: Needs more variations
                the_person "My boss certainly is! He's so moody these days, one moment he's sealing a big deal and laughing, the next he's having a breakdown."
                the_person "Today I brought him his lunch and I guess I got something wrong, because he started complaining."
                if the_person.effective_sluttiness("vaginal_sex") > the_person.love: #She doesn't care about you enough to hide what she's doing #TODO: This should also consider if she's in a committed relationship with you
                    the_person "But I wasn't going to be having any of that! I closed the door, I gave him a condom, pulled up my skirt and bent over his desk..."
                    $ mc.change_locked_clarity(30)
                    the_person "He wasn't complaining about his food after that, but I hope he doesn't start expecting that all the time!"
                else:
                    $ mc.change_locked_clarity(10)
                    the_person "But I wasn't going to have any of that! I closed the door, gave him a condom, pulled up my skirt and bent over his desk, and... Ehm..."
                    "She stops and blushes, looking away from you."
                    the_person "Sorry, maybe I shouldn't be talking about this with you. I made sure he was happy, that's all."
                ...
                the_person "It is, but I feel like I'm making a difference for the office."
                the_person "My boss had a meeting with a big rival today, apparently things were tense between them."
                the_person "He had me get some drinks for the two of them. The other guy made a comment about my ass when I bent over to serve them."
                $ mc.change_locked_clarity(30)
                the_person "Well, I wanted to help so I told him it wasn't any problem and pulled up my skirt and let him feel me up."
                the_person "When I left they were talking business again and they sounded like old friends!"
                the_person "They made a deal later that day, and my boss said it was all because of me!"
                the_person "I would have never done that when I was younger, but now I'm seeing all the different ways I can help out the team."
...
label mom_work_secretary_replacement_intro_bigger_tits(the_person): #Breakout for telling her she needs to get bigger tits and for setting up related actions/events
    ...
    if the_person.has_large_tits:
        "She puts an arm under her breasts and lifts them for emphasis."
    ...
    "[the_person.possessive_title!c] thinks about it for a long moment, then nods."
...
label mom_work_secretary_replacement_bigger_tits_options(the_person):
    menu:
        "I'll pay\n{menu_red}Costs: $7,000{/menu_red}" if mc.business.has_funds(7000): #NOTE: Requirements not needed, you can come back and pay in a few days.
        ...
        "I'll pay\n{menu_red}Requires: $7,000{/menu_red} (disabled)" if not mc.business.has_funds(7000):
            pass

        "Give her some serum" if mc.inventory.has_serum: #Note The seduce event has already been added and is watching her breast size, so if it goes up she'll trigger it right away
        ...
        "Give her some serum\n{menu_red}Requires: Serum Dose{/menu_red} (disabled)"if not mc.inventory.has_serum:
            pass
        ...
        "Make her pay" if the_person.love >= 30 and the_person.obedience >= 130:
            ...
            "[the_person.possessive_title!c] scowls and thinks for a long moment. Finally she sighs and nods."
            the_person "Okay, I'll do it [the_person.mc_title]. You're right, it's important."
            $ the_person.event_triggers_dict["mom_work_tit_options_reintro"] = False

            $ add_mom_got_boobjob_action(the_person)

        "Make her pay\n{menu_red}Requires: 30 Love, 130 Obedience{/menu_red} (disabled)" if the_person.love < 30 or the_person.obedience < 130:
            pass
...
label mom_work_secretary_replacement_report(the_person):
    ...
    "[the_person.possessive_title!c] is smiling happily when you step close to her."
        ...
        menu:
            ...
            "Ask how she did it":
                ...
                if the_person.event_triggers_dict.get("mom_replacement_seduce_practice", "titfuck") == "titfuck":
                    $ mc.change_locked_clarity(20)
                    the_person "So I got onto my knees and used my breasts to... pleasure him, just like we practised."
                elif the_person.event_triggers_dict.get("mom_replacement_seduce_practice", "titfuck") == "blowjob":
                    $ mc.change_locked_clarity(20)
                    the_person "So I got onto my knees and used my mouth to... pleasure him, just like we practised."
                else:
                    $ mc.change_locked_clarity(10)
    ...
    $ add_mom_lust_story_bridge_action()
...
label mom_promotion_boss_phase_one(the_secretary):
    ...
    $ met_before = mc.phone.has_number(iris)    # lily phone quest
    if not met_before:
        $ iris_init_schedule()
    ...
    $ iris.draw_person(position = "sitting")
    ...
    iris "I just overheard, you're here to talk to [mom_boss_quick_name]?"
    mc.name "Yeah, I am."
    iris "Sorry, this probably seems really strange. I'm his daughter, he's supposed to be meeting me..."
    "She checks her phone and sighs."
    iris "Well, half an hour ago, actually. If, um... If you talk to him, could you let him know I'm down here?"
    iris "Sorry, I know you're probably really important and I shouldn't be bothering you!"
    ...
    "She smiles meekly and waves as you head off to the bank of lobby lifts."
    $ clear_scene()
    "You take a lift up to the sixth floor and follow the signage to [mom_boss_quick_name]'s office."
    ...
    menu:
        "I want to help you":
            ...
            mom_boss_quick_name "I... What? Help with what? This is a weird way to ask for a job, kid."
            ...
            mc.name "I'll tell you what. I'll keep working on her, and I'll check back in with you in a while."
            mc.name "I don't need any commitment from you, just understand that I'm helping you out."
            mom_boss_quick_name "Whatever kid. Just get out of here."
    ...
    $ mc.location.show_background()
    "You return to the lifts and take one back to the lobby, unsure of what to do next."
    ...
    $ scene_manager = Scene()
    $ scene_manager.add_actor(the_secretary, position = "sitting")
    $ scene_manager.add_actor(iris, emotion = "sad")

    the_secretary "... okay sweetheart. I'm sure he's on his way, it'll probably be a super quick meeting..."
    iris "Maybe... Can I just sit here?"
    "She glances at you as you step out of the lift."
    menu:
        "Comfort her":
            ...
            iris "I'm just going to wait here. He won't be long, right?"
            ...
            iris "But what if he comes looking for me?"
            ...
            $ iris.change_happiness(5)
            mc.name "I don't think I got your name, by the way."
            "She gives you a weak smile."

            if met_before:   # met before (sister phone quest)
                mc.name "Haven't we met before?"
                iris "I don't think..."
                mc.name "Of course, you are [iris.fname], we met at the electronics store, when I bought that phone for my sister."
                iris "Oh right, you are [lily.fname]'s cool brother."
            else:
                $ iris.set_title(iris.name)
                # use name until person_introduction is completed (mc_title set)
                iris "I'm [iris.name]. Nice to meet you. Well, not that nice, but you know..."
                $ iris.set_possessive_title(mom_boss_quick_name + "'s daughter")
                "She looks at you expectantly, waiting for your name in return."
                call person_introduction(iris, girl_introduction = False) from _call_person_introduction_5
            mc.name "Come on, let's go find a drink. Know anywhere good around here?"
            "[iris.possessive_title!c] shakes her head meekly."
            ...
            $ iris.change_happiness(10)
            "You order drinks and sit down. Soon enough you have [iris.title] talking and smiling, clearly happier than she was before."
            call date_conversation(iris) from _call_date_conversation
            iris "Hey, so uh... Thanks for doing this for me. I was a mess back there."
            mc.name "I just took a pretty girl out for drinks, I'm not exactly a super hero."
            iris "Well it meant a lot to me. So maybe... we could do this again sometime?"
            mc.name "That sounds like a..."
            "You're interrupted by her phone buzzing. She glances at it and sighs."
            if met_before:
                iris "That's him, I need to get going. Do you still have my number?"
                mc.name "Sure, I'll give you a call soon, so we can get together."
            else:
                iris "That's him, I need to get going. Here, let me give you my number."
            ...
            iris "Did something happen at your meeting? You know what, I don't need to know."
            iris "I won't say a word. Just promise you'll call, okay?"
            mc.name "Deal."
            $ mc.phone.register_number(iris)
            "You hand her your phone, and she keys in her number. She hands it back with a smile."
            iris "See you around [iris.mc_title]."
            mc.name "See you soon [iris.fname]."
            $ clear_scene()
    ...
    "Well, this conversation has left you with a choice."
    "You can keep serums going on [mom.possessive_title]. Things are already progressing with her and [mom_boss_quick_name] nicely."
    "You can keep it up, and maybe you'll be able to convince him to help you out."
    "He made it pretty clear though, if she wants to keep her job, she's going to need to put out, eventually."
    "Maybe you should see if you can convince her to quit? She could come work for you. Or maybe even just stay home."
    "Whatever you decide, you should check back with [mom_boss_quick_name] as things progress."


    $ scene_manager.clear_scene()
    $ scene_manager = None
    $ mc.change_location(downtown) #Make sure we move you downtown
    $ mom_boss_quick_name = None
...
label mom_convince_quit_label(the_person):
    ...
    if the_person.opinion(("working", "HR work")) < 0:
        "She sighs and nods."
        ...
        "[the_person.possessive_title!c] waves her hand dismissively."
    ...
    "Warning! If you convince [the_person.possessive_title] to quit her job, it will change her lust story."
    "She will no longer be able to transform into the office slut... but maybe you could take the place of her boss?"
    menu:
        "You hate working there!" if the_person.known_opinion.working == -2 and the_person.known_opinion.hr_work == -2:
            ...
            $ mc.change_locked_clarity(5)
            "[the_person.possessive_title!c] wraps you up in a hug."
        ...
        "You hate working there!\n{menu_red}Requires: Hates working, Hates HR work{/menu_red} (disabled)" if not (the_person.opinion.working == -2 and the_person.opinion.hr_work == -2):
            pass

        "I'll take care of us" if the_person.is_girlfriend:
        ...
        "You can work for me" if not mc.business.at_employee_limit:
            ...
            menu:
                "I want you by my side" if the_person.is_girlfriend:
                    ...
                    if _return:
                        ...
                        call add_role_family_employee_and_set_titles(the_person) from _call_add_role_family_employee_and_set_titles_hire_mom_convince_quit_1
                ...
                "We'll see each other so much more often" if the_person.love >= 50:
                    ...
                    if _return:
                        mc.name "One more thing, [the_person.name]."
                        call add_role_family_employee_and_set_titles(the_person) from _call_add_role_family_employee_and_set_titles_hire_mom_convince_quit_2
                        mc.name "Welcome to the team [the_person.title]."
                ...
                "I'll pay you more than they do":
                    ...
                    if _return:
                        mc.name "One more thing, [the_person.name]."
                        call add_role_family_employee_and_set_titles(the_person) from _call_add_role_family_employee_and_set_titles_hire_mom_convince_quit_3
                        mc.name "Welcome to the team [the_person.title]."
                        the_person "Thank you [the_person.mc_title], I'm sure this is going to be great!"
                        the_person "Now I just need to call my boss and tell him I won't be coming into work. I'm sure he won't be happy to hear that!"
                        $ the_person.event_triggers_dict["mandate_bc"] = False
