...
label ellie_sex_responses_oral(the_person):
    if the_person.arousal_perc < 40:
        ...
        if the_person.sluttiness > 50:
            ...
            the_person "You're so good at that... Stars, it's starting to drive me crazy!"
    else:
        if the_person.sluttiness > 50:
            if not the_person.has_significant_other:
...
label ellie_sex_responses_vaginal(the_person):
    if the_person.energy < 10:
        call low_energy_sex_responses_vaginal(the_person) from _call_low_energy_sex_responses_vaginal_2
        return
    ...
    if the_person.arousal_perc < 40:
        ...
        if the_person.sluttiness > 50:
            if not the_person.has_significant_other:
                ...
                the_person "Do me, do me harder! My [the_person.so_title] never does me like this, it feels so good!"
        else:
...
label ellie_sex_responses_anal(the_person):
    if the_person.energy < 10:
        call low_energy_sex_responses_anal(the_person) from _call_low_energy_sex_responses_anal_2
        return
    ...
    if ellie_is_a_squirter():
        if "the_position" in globals():
            if the_position == standing_finger:
                "[the_person.possessive_title!c]'s pussy gushes her juices all around your fingers as she cums."
            elif the_position == standing_grope:
                "[the_person.possessive_title!c]'s pussy gets significantly wetter as she cums."
                ...
                "[the_person.possessive_title!c] fluids start actively running down the dildo as she cums."
            else:
                "[the_person.possessive_title!c]'s pussy gushes as she cums."
        else:
            "[the_person.possessive_title!c]'s pussy gushes as she cums."
    return
...
label ellie_clothing_review(the_person):
    ...
    if the_person.should_wear_uniform:
        ...
        if the_person.sluttiness > 40:
            ...
            the_person "My clothes are a mess! Just wait a minute while I get cleaned up."
...
label ellie_flirt_response_employee_uniform_low(the_person):
...
label ellie_flirt_response_employee_uniform_mid(the_person):
    if the_person.judge_outfit(the_person.outfit):
        $ mc.change_locked_clarity(10)
        the_person "I did't have much choice in the matter."
        if the_person.tits_visible:
            the_person "I'm don't think my boobs should be showing."
            "She looks down uncomfortably at her breasts."
        else:
            $ the_person.draw_person(position = "walking_away")
            the_person "Not that I mind..."
            "She gives you a full spin, letting you look at her from every angle."
            $ the_person.draw_person()
        mc.name "It absolutely looks great on you."
        "[the_person.possessive_title!c] smiles, blushing a little from the compliment."

    else:
        $ mc.change_locked_clarity(10)
        the_person "I think it shows off way too much!"
        if the_person.vagina_visible:
            the_person "Look at me, you can see everything!"
            the_person "No offence, but this uniform makes me look like a whore."
        elif the_person.tits_visible:
            the_person "Dear lord, my tits are just hanging out!"
            the_person "No offence, but your uniform makes me look like a slut."
        else:
            the_person "No offence, but this uniform is not decent at all."
        mc.name "I understand, but it's important for the business."
        the_person "I suppose. But that doesn't mean I have to like it."
...
label ellie_flirt_response_mid1(the_person):
    $ mc.change_locked_clarity(10)
    the_person "Ah..."
    "[the_person.possessive_title!c] blushes and looks away."
    $ mc.change_locked_clarity(10)
    ...
    if mc.location.person_count > 1 and the_person.effective_sluttiness("kissing") < (25 - (5*the_person.opinion.public_sex)):
        ...
        menu:
            "Find somewhere more quiet\n{menu_yellow}[mc.location.interruption_info_text]{/menu_yellow}":
                ...
                call mc_change_to_private_location(the_person) from _call_mc_change_to_private_location_ellie_flirt_response_high_2
                ...
                call mc_restore_original_location(the_person) from _call_mc_restore_original_location_ellie_flirt_response_high_2
        ...
        menu:
            "Kiss her":
                ...
                $ the_person.draw_person(position = "kissing", special_modifier = "kissing")
                "You close the final gap and kiss her. She returns the kiss immediately, leaning her body against yours."
                call mc_move_to_private_location(the_person) from  _call_mc_move_to_private_location_ellie_flirt_response_high
                call fuck_person(the_person, start_position = kissing, private = mc.location.person_count < 2, skip_intro = True) from _call_fuck_ellie_48
                $ the_person.call_dialogue("sex_review", the_report = _return)
                call mc_restore_original_location(the_person) from _call_mc_restore_original_location_ellie_flirt_response_high
        ...
        if the_person.effective_sluttiness("kissing") < (25 - (5*the_person.opinion.public_sex)):
            ...
            menu:
                "Find somewhere more quiet\n{menu_yellow}[mc.location.interruption_info_text]{/menu_yellow}":
                    ...
                    call mc_change_to_private_location(the_person) from _call_mc_change_to_private_location_ellie_flirt_response_girlfriend
                    $ the_person.draw_person(position = "kissing", special_modifier = "kissing")
                    ...
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    call mc_restore_original_location(the_person) from _call_mc_restore_original_location_ellie_flirt_response_girlfriend
            ...
            menu:
                "Make out":
                    ...
                    call mc_move_to_private_location(the_person) from _call_mc_change_to_private_location_ellie_flirt_response_girlfriend_2
                    call fuck_person(the_person, start_position = kissing, private = _return, skip_intro = True) from _call_fuck_ellie_72
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    call mc_restore_original_location(the_person) from _call_mc_restore_original_location_ellie_flirt_response_girlfriend_2
    ...
    if mc.location.person_count > 1: #There are other people around, she's nervous about people finding out what you're doing.
        if (the_person.opinion.cheating_on_men *15) + the_person.effective_sluttiness() > 50: #SHe's turned on by flirting in public or doesn't think anything is wrong with it
            ...
            menu:
                "Find somewhere more quiet\n{menu_yellow}[mc.location.interruption_info_text]{/menu_yellow}":
                    ...
                    call mc_change_to_private_location(the_person) from _call_mc_change_to_private_location_ellie_flirt_response_affair
                    ...
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    call mc_restore_original_location(the_person) from _call_mc_restore_original_location_ellie_flirt_response_affair
        ...
        menu:
            "Make out":
                ...
                call mc_move_to_private_location(the_person) from _call_mc_move_to_private_location_ellie_flirt_response_affair_2
                call fuck_person(the_person, private = _return, start_position = kissing, skip_intro = True) from _call_fuck_ellie_75
                $ the_person.call_dialogue("sex_review", the_report = _return)
                call mc_restore_original_location(the_person) from _call_mc_restore_original_location_ellie_flirt_response_affair_2
            "Just flirt":
    ...
    if mc.condom: #TODO: All of the cum-drunk stuff
        ...
        if the_person.wants_creampie:
            ...
            if not the_person.on_birth_control: #You need to pull out, I'm not on the pill!
                ...
                the_person "Oh, lord, you should pull out, just in case!"
    return
    ...
    if the_person.wants_creampie:
        if the_person.knows_pregnant:
            ...
            if the_person.has_significant_other:
                ...
                the_person "I feel bad for my [the_person.so_title], but you do it so much better than him."
            else:
            ...
            if the_person.has_significant_other:
                ...
                the_person "Stars, I hope you didn't knock me up though. I don't want to have to explain that to my [the_person.so_title]."
            else:
        ...
        if not the_person.on_birth_control:
            if the_person.has_significant_other:
                the_person "Heck! I told you to pull out! I have a [the_person.so_title], what if I got pregnant?"
...
label ellie_cum_anal(the_person):
    if the_person.sluttiness > 75 or the_person.opinion.anal_creampies > 0:
        the_person "Oh god yes, cum inside my filthy little ass!"
    elif the_person.opinion.anal_creampies < 0:
        the_person "Oh god, not inside, he's cumming in my ass."
    else:
        the_person "Oh god, forgive me! He's filling up this sinners ass."
    return
...
label ellie_date_seduction(the_person):
    if the_person.is_girlfriend:
        ...
        if the_person.wants_creampie and the_person.effective_sluttiness() > the_person.get_no_condom_threshold() and the_person.opinion.bareback_sex >= 0 and the_person.opinion.creampies >= 0 and not the_person.on_birth_control and not the_person.knows_pregnant:
            ...
            the_person "Would you like to come home with me? For you I'll be the slut my [the_person.so_title] wishes I was."
        else:
...
label ellie_sex_review(the_person, the_report):
    ...
    # special condition - you fucked her brains out
        ...
        call sex_review_trance(the_person) from _call_sex_review_trance_ellie_sex_review
...
label ellie_vaginal_sex_taboo_break(the_person): #TODO: add a "I don't do anal""you do for me" style taboo break
...
label ellie_condomless_sex_taboo_break(the_person):
    if the_person.knows_pregnant:
        ...
        if the_person.on_birth_control:
            the_person "I'm taking the pill, so it should be fine, right? Maybe you should pull out, just in case."
            $ the_person.update_birth_control_knowledge()
        elif the_person.opinion.creampies > 0:
