...
label lily_sex_review(the_person, the_report):
    ...
    # special condition - you fucked her brains out
        ...
        call sex_review_trance(the_person) from _call_sex_review_trance_lily_sex_review
    ...
    if the_report.get("creampies", 0) > 0 and not the_person.on_birth_control and not the_person.knows_pregnant:
        the_person "Well [the_person.mc_title], you have to tell [mom.fname] when I get pregnant."
...
label lily_sex_responses_foreplay(the_person):
    if the_person.arousal_perc < 45:
        if the_person.sluttiness > 50:
            ...
            the_person "Mom would be so disappointed in you..."
        ...
        if the_person.sluttiness > 50:
            if the_person.outfit.wearing_panties:
                ...
                the_person "Fuck, you're getting me so wet I'm going to soak right through my [the_person.outfit.get_lower_top_layer.display_name]..."
        else:
...
label lily_sex_responses_oral(the_person):
    if the_person.arousal_perc < 45:
        if the_person.sluttiness > 50:
            "[the_person.possessive_title!c] wiggles her hips happily as you eat her out."
        ...
        if the_person.sluttiness > 50:
            ...
            "[the_person.possessive_title!c] sighs happily."
        else:
...
label lily_sex_responses_vaginal(the_person):
    if the_person.energy < 10:
        call low_energy_sex_responses_vaginal(the_person) from _call_low_energy_sex_responses_vaginal_5
        return
    ...
    if the_person.arousal_perc < 45:
        ...
        if the_person.sluttiness > 50:
            ...
            "[the_person.possessive_title!c] moans enthusiastically."
        ...
        if the_person.sluttiness > 50:
            ...
            "[the_person.possessive_title!c] mumbles softly to herself between happy moans."
            the_person "Oh fuck, I'm going to cum... I'm going to cum on my brother's cock... Oh fuck!"

    return

label lily_sex_responses_anal(the_person):
    if the_person.energy < 10:
        call low_energy_sex_responses_anal(the_person) from _call_low_energy_sex_responses_anal_5
        return
    ...
    if the_person.arousal_perc < 45:
        if the_person.sluttiness > 50:
            ...
            "[the_person.possessive_title!c] whimpers to herself as you stretch out her ass."
...
label lily_clothing_reject(the_person):
    if the_person.obedience > 140:
        the_person "Oh, I wish I could wear this [the_person.mc_title], but I don't think I could ever explain it to [mom.fname] if she saw."
    else:
        if the_person.sluttiness > 60:
        ...
        if the_person.obedience < 100:
            ...
            if the_position.skill_tag == "Foreplay":
                ...
                if not had_family_threesome(): # mod only
                    ...
                    the_person "I like it, should we ask [mom.fname] to join us?"
                else:
                    the_person "Oh yes, brother, please, fuck me hard."
    else:
        if the_person.love < 40:
            if not mom_knows_about_lily(): # mod only
                the_person "Okay, let's do it. Just make sure [mom.fname] never finds out, okay?"
            elif had_family_threesome():
                the_person "Okay, let's do it, next time we should include [mom.fname], okay?"
            else:
                the_person "Okay, I'm feeling a little worked up myself."
        else:
            if the_position.skill_tag == "Foreplay":
    ...
    if the_person.sluttiness > 70:
        ...
        if the_person.obedience > 180:
            ...
            if mom_knows_about_lily():
                ...
                the_person "Okay, just promise me [mom.fname] will never know."
    return
...
label lily_sex_angry_reject(the_person):
    if the_person.sluttiness < 20:
        ...
        the_person "I... Just get out of here. You're lucky I don't want to have to explain how this happened to [mom.fname]."
    return
...
label lily_seduction_accept_crowded(the_person):
    if the_person.sluttiness < 20:
        ...
        the_person "Oh god, that sounds so hot. I hope nobody here recognises me!"
    return
...
label lily_seduction_refuse(the_person):
    if the_person.sluttiness < 20:
        ...
        the_person "No, wait, we really shouldn't be doing this [the_person.mc_title]... What if [mom.fname] knew, or my friends knew?"
...
label lily_flirt_response_low(the_person):
    ...
    if mom.judge_outfit(the_person.outfit, 5, use_taboos = False): # Mom is sluttier or similar
        the_person "Mom helped me pick it out. You should come shopping with us some day!"

    else: #It's sluttier than Mom would like
        the_person "Mom really didn't like it when I bought this, but I just couldn't say no."
        the_person "Maybe you can come shopping with us one day and convince her to relax a little!"
    mc.name "Maybe I will."
    return

label lily_flirt_response_low1(the_person):
    the_person "Aww, thank you. I think it looks cute too."
    mc.name "Anytime, [the_person.title]!"
    $ mc.change_locked_clarity(5)
    return

label lily_flirt_response_low2(the_person):
    the_person "Not really? Why?"
    mc.name "I like it."
    if mom.judge_outfit(the_person.outfit, 5, use_taboos = False): # Mom is sluttier or similar
        the_person "Even mom likes it, can you believe that."
        mc.name "Why shouldn't she, it looks great."
    else:
        the_person "Mom, keeps nagging me too wear something more decent."
        mc.name "Maybe she should loosen up a little, you look great."
    $ mc.change_locked_clarity(5)
    return
...
label lily_flirt_response_mid(the_person):
    if the_person.effective_sluttiness("underwear_nudity") < 20: #Not very slutty, so it must be high love.
        "[the_person.possessive_title!c] gasps and blushes."
        ...
        $ mc.change_locked_clarity(10)
        "[the_person.possessive_title!c] smiles and turns around, peeking over her shoulder to talk to you."
...
label lily_flirt_response_mid1(the_person):
    if mc.location.person_count > 1:
        "[the_person.possessive_title!c] smiles, then glances around."
        the_person "Not so loud, what if someone heard you talking to your sister like that."
    $ mc.change_locked_clarity(10)
    the_person "It does look cute, doesn't it."
    "[the_person.possessive_title!c] gives you wink."
    $ mc.change_locked_clarity(10)
    ...
    the_person "Alright, you can take your sister out for a coffee, that's not weird."
    return
        ...
        if the_person.effective_sluttiness() > (25 - the_person.opinion.incest*5): #She's slutty, but you need to find somewhere private so people don't find out.
            ...
            menu:
                "Find somewhere more quiet\n{menu_yellow}[mc.location.interruption_info_text]{/menu_yellow}":
                    ...
                    call mc_change_to_private_location(the_person) from _call_mc_change_to_private_location_lily_flirt_response_high
                    ...
                    $ the_person.call_dialogue("sex_review", the_report = _return)
                    call mc_restore_original_location(the_person) from _call_mc_restore_original_location_lily_flirt_response_high
...
label lily_flirt_response_text(the_person):
    ...
    if the_person.is_affair: #NOTE: In theory neither of these roles are possible, but they might be in the future.
        the_person "Well hi! Going well, wish I was with you though."
        the_person "Think you can sneak into my room tonight? We can have some fun as long as [mom.fname] doesn't know."
        ...
        if the_person.effective_sluttiness() > the_person.love:
            ...
            the_person "We should hang out, I'm sure we could get into some trouble together."
        else:
...
label lily_condom_ask(the_person):
    if the_person.on_birth_control:
        ...
        the_person "You should really put on a condom. It would be really bad if you... finished inside me."
...
label lily_cum_face(the_person):
    if the_person.obedience > 180:
        if the_person.sluttiness > 60:
            ...
            the_person "Wow... it's all over my face. I wonder if [mom.fname] would lick it off when she joins us."
        else:
            the_person "Oh my god, you got it all over me... You can never let [mom.fname] know about this, okay?"
    else:
...
label lily_cum_mouth(the_person):
    if the_person.obedience > 180:
        if the_person.sluttiness > 60:
            ...
            the_person "Mmm this is just great... perhaps I should share this with [mom.fname] next time."
        else:
            the_person "Oh my god... [mom.fname] can never know about this [the_person.mc_title]. She'd kill us both."
    else:
        if the_person.sluttiness > 80:
    ...
    if mc.condom:
        ...
        if the_person.wants_creampie:
            ...
            if not the_person.on_birth_control: #You need to pull out, I'm not on the pill!
                ...
                the_person "Ah! You... You need to pull out! We can't take any risks!"
    return
...
label lily_cum_anal(the_person):
    if the_person.sluttiness > 75 or the_person.opinion.anal_creampies > 0:
        the_person "Fill me up! Shoot all that cum inside your little sister's ass."
    elif the_person.opinion.anal_creampies < 0:
        the_person "Oh shit, not in my ass bro!"
    else:
...
label lily_sex_strip(the_person):
    if the_person.sluttiness < 20:
        if the_person.arousal_perc < 50:
            the_person "I feel like [mom.fname] in this outfit. One second..."
        else:
...
label lily_being_watched(the_person, the_watcher, the_position):
    ...
    if the_person.sluttiness >= the_position.slut_cap and the_watcher.sluttiness >= the_position.slut_cap:
        ...
        the_person "Don't listen to [title], I'm having a great time. She's just jealous her brother doesn't treat her like this!"

    elif the_person.sluttiness >= the_position.slut_cap and the_watcher.sluttiness < the_position.slut_cap:
        #She's super slutty and encourages the watcher to be slutty.
        $ the_person.change_arousal(1)
        the_person "We just love each other so much. You understand, right?"
        "[the_person.title] seems turned on by [title] watching you and her [the_position.verb]."
        ...
        $ the_person.change_arousal(1)
        "Your little sister seems turned on by [title] watching you and her [the_position.verb]."
        ...
        the_person "I'm so glad you don't think this is too weird."
...
label lily_sex_take_control(the_person):
    if the_person.has_cum_fetish:
        the_person "Just relax [the_person.mc_title], you need to fill up your little sister with you potent seed."
    elif the_person.arousal_perc > 60:
        the_person "[the_person.mc_title], don't worry. Your little sister is going to take good care of you..."
    else:
        the_person "Oh [the_person.mc_title], you can't get a girl all worked up then just walk away. Here, just leave it to your little sister..."
    return

label lily_sex_beg_finish(the_person):
    the_person "Wait [the_person.mc_title], you can't stop now, I'm so close! Please, let your little sister cum!"
    return
...
label lily_kissing_taboo_break(the_person):
    ...
    if the_person.event_triggers_dict.get("kissing_revisit_count", 0) == 0:
        ...
        the_person "Oh my god, I forgot about that. That was different, we were young and just practising."
...
label lily_touching_body_taboo_break(the_person):
    if the_person.event_triggers_dict.get("kissing_revisit_count", 0) == 0:
        if the_person.love > 20:
            ...
            the_person "Okay, you're right [the_person.mc_title]. Just don't tell [mom.fname] okay?"
...
label lily_touching_penis_taboo_break(the_person): #TODO: Should this taboo have a revisit
    if the_person.love > 30:
        ...
        the_person "Are all guys as big as you, or are you... Unusual?"
        "You shrug?"
    ...
    if the_person.event_triggers_dict.get("oral_revisit_count", 0) == 0:
        ...
        if the_person.love > 30:
            if the_person.has_taboo("touching_penis"):
                ...
                the_person "You shouldn't... [mom.fname] would be so angry if she knew what we were doing."
...
label lily_sucking_cock_taboo_break(the_person):
    ...
    if the_person.event_triggers_dict.get("oral_revisit_count", 0) == 0:
        if the_person.love > 40:
            ...
            "[the_person.possessive_title!c] takes a long moment to think, then nods enthusiastically."
            ...
            the_person "Why not? Because I'm your sister and [mom.fname] would kill us both if she found out!"
            mc.name "So we'll just make sure she doesn't find out. Come on [the_person.title], you want to try it too, right?"
            "[the_person.possessive_title!c] blushes and nods meekly."
...
label lily_licking_pussy_taboo_break(the_person):
    if the_person.event_triggers_dict.get("oral_revisit_count", 0) == 0:
        if the_person.love > 40:
            ...
            "[the_person.possessive_title!c] seems embarrassed by the idea. She looks away and blushes."
            the_person "I don't know [the_person.mc_title], maybe we shouldn't..."
            if the_person.has_taboo("sucking_cock"):
                mc.name "Why not? Don't you trust me?"
                the_person "I do, but... you're my brother, you know? [mom.fname] would be so angry if she knew."
            ...
            if the_person.has_taboo("sucking_cock"):
                the_person "We shouldn't... [mom.fname] would be so angry."
                mc.name "I didn't ask if [mom.fname] would be angry. I asked if you want me to."
    ...
    if the_person.event_triggers_dict.get("anal_revisit_count", 0) == 0:
        if the_person.love > 60:
            ...
            if the_person.has_taboo("vaginal_sex"):
                ...
                "[the_person.possessive_title!c] seems unsure."
...
label lily_condomless_sex_taboo_break(the_person):
    ...
    if the_person.has_taboo("vaginal_sex"):
        ...
        "[the_person.possessive_title!c] still seems uncertain."
...
label lily_bare_tits_taboo_break(the_person, the_clothing):
    ...
    "[the_person.possessive_title!c] seems equal parts embarrassed and excited."
    the_person "Oh my god, you want to look at your sister's boobs? Do you... think they're cute?"
    if not the_person.has_large_tits:
        the_person "I hoped they would be big like mom's, but I don't think that's going to happen."
...
label lily_bare_pussy_taboo_break(the_person, the_clothing):
    ...
    "[the_person.possessive_title!c] seems excited rather than scared of the idea, but needs a little more convincing."
...
label lily_creampie_taboo_break(the_person):
    if the_person.wants_creampie:
        the_person "Oh my god [the_person.mc_title], you just came inside me!"
        ...
        "[the_person.possessive_title!c] seems a little shocked."
        if the_person.on_birth_control:
            the_person "You just... came inside me. I've got my brother's cum inside my pussy..."
            ...
            the_person "You just... came inside me. I've got a pussy full of my brother's cum, and I'm not on birth control."
            $ the_person.update_birth_control_knowledge()
