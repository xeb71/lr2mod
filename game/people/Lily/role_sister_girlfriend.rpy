...
label sister_girlfriend_intro(the_person):
        ...
        "Most sisters don't [most_phrase]":
            if most_done == "vaginal":
                ...
                if the_person.effective_sluttiness() < 40:
                    ...
                    if the_person.vaginal_sex_count > 1:
                ...
                if the_person.effective_sluttiness() < 40:
                    the_person "Oh god, I knew that was a mistake!"
                    the_person "[the_person.mc_title], we need to forget about that!"
                    if the_person.anal_sex_count > 1:
                        mc.name "Once might have been a mistake, but we're so far past that now."
                    else:
                        mc.name "I can't forget it [the_person.title], you were incredible! Now you're all I want!"
                else:
    ...
    $ convinced = False
    menu:
        "Who cares what other people think?" if the_person.known_opinion.incest > 0:
    ...
    menu:
        ...
        "Don't worry, I'm dating her too" if mom.is_girlfriend: #TODO: Requires: you're also already in a relationship with Mom.
            $ convinced = True
            ...
            if the_person.event_triggers_dict.get("mom_girlfriend_sister_knows", False):
                ...
                the_person "That's my [mom.fname] you're fucking, you know!"
...
label sister_girlfriend_return(the_person):
    ...
    if the_person.event_triggers_dict.get("sister_girlfriend_mom_blessing_given", False):
        ...
        "[the_person.possessive_title!c] frowns."
...
label sister_girlfriend_mom_blessing(the_person):
    ...
    "[the_person.possessive_title!c] doesn't say anything for a long moment."
    ...
    menu:
        "Isn't love more important?" if the_person.known_opinion.incest > 0:
            $ convinced = True
            ...
            "[the_person.possessive_title!c]'s expression softens."
            the_person "If this is what you both want and you understand the challenges, then I won't stop you."
            mc.name "Thank you mom, I knew we could trust you."
            "[the_person.possessive_title!c] smiles and opens her arms up for a hug."
            $ the_person.change_happiness(10)
            the_person "Come here, give me a hug. I'll always be here for both of you."
            "You let [the_person.possessive_title] pull you into her arms. After a long moment she lets you go."
        ...
        "Demand she allows it" if the_person.obedience >= 200:
            $ convinced = True
            "You step close to your mother and put your hand on the back of her head."
        ...
        "Demand she allows it\n{menu_red}Requires: [the_person.title] 200 Obedience{/menu_red} (disabled)" if the_person.obedience < 200:
            pass
        ...
        "I'm just joking!":
            ...
            mc.name "Hahah, oh man mother, you should have seen your face!"
            ...
            "[the_person.possessive_title!c] lets the subject drop for now."
