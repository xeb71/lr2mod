##########################################
# This file holds all of the role requirements and labels for the main un-skippable sister storyline.
##########################################
...
label sister_intro_crisis_label(the_person):
    ...
    "[the_person.possessive_title!c] steps into your room and closes the door behind her."
    ...
    the_person "If you could just give me a {i}tiny{/i} bit of cash I could show [mom.fname] I can take care of myself."
    ...
    menu:
        "Ask [the_person.title] to test serum for you":
            ...
            "[the_person.possessive_title!c] thinks about it for a moment, then nods."
            the_person "Okay, but I want $50 each time."
            mc.name "You drive a hard bargain sis. You've got a deal."
            "You shake on it."
            $ the_person.change_obedience(5)
            the_person "Thank you so much [the_person.mc_title]. Uh, if [mom.fname] asks just say I got a part-time job."
...
label sister_serum_test_label(the_person):
    ...
    if _return:
        $ mc.business.change_funds(-50, stat = "Serum Testing")
...
label sister_strip_intro_label(the_person):
    ...
    "[the_person.possessive_title!c] comes into your room and shuts the door behind her. She seems nervous, avoiding eye contact as she comes closer."
    mc.name "Any time, what's up?"
    the_person "You know how I've been testing some of that lab stuff you make? For money?"
    mc.name "Yeah."
    the_person "Well I've been out shopping, and [mom.fname] would {i}kill{/i} me if she knew how much I was spending, so I was hoping you could pay me some more."
    ...
    "[the_person.possessive_title!c] puts her arms behind her back and pouts at you."
    menu:
...
label strip_explanation(the_person):
    ...
    "You nod."
    "[the_person.possessive_title!c] seems surprised, but not particularly offended by the idea. She takes a long moment to consider it."
    ...
    the_person "And obviously you can't touch me. Or yourself. And you can {i}never{/i} tell [mom.fname] about it."
...
label sister_offer_to_hire(the_person):
    ...
    if the_person.event_triggers_dict.get("dropout_convince_progress", 0) == 2:
        ...
        the_person "Shut up. [mom.fname] would never let me drop out."
        mc.name "Is that the only thing stopping you? If I convince mom, will you drop out and come work for me?"
        ...
        if the_person.event_triggers_dict.get("dropout_convince_progress", 0) == 0:
            $ add_sister_dropout_convince_action()
    return
...
label sister_offer_to_hire_2(the_person):
    ...
    the_person "What's there to think about? Unless [mom.fname] is going to let me drop out of school I don't have the time."
    ...
    mc.name "Don't worry about that, the most important thing is that she said yes."
    mc.name "So, interested in a job?"
    "[the_person.possessive_title!c] thinks for a long moment, clearly unsure."
    the_person "I don't know..."
    menu:
        "You hate school" if the_person.known_opinion.research_work <= -2:
        ...
        "You hate school\n{menu_red}Requires: Hates research work{/menu_red} (disabled)" if the_person.known_opinion.research_work > -2:
            pass

        "We'll get to work together!" if the_person.is_girlfriend:
        ...
        "I'll double your normal pay":
            ...
            $ amount = base_salary_calculation(the_person)
            mc.name "Around $[amount:.0f] per day."
...
label hire_sister_assign_department(the_person):
    ...
    if _return:
        ...
        call add_role_family_employee_and_set_titles(the_person) from _call_add_role_family_employee_and_set_titles_hire_sister_assign_department
        ...
        $ finish_sister_drop_out_of_school()
    else:
...
label mother_sister_dropout_convince_label(the_person):
    ...
    the_person "She... WHAT?"
    "[the_person.possessive_title!c] shakes her head in immediate refusal."
    ...
    menu:
        "We need the money!" if mom.has_job(unemployed_job):
            ...
            "[the_person.possessive_title!c] looks conflicted, but finally she nods."
        ...
        "We need the money!\n{menu_red}Requires: [the_person.title] is Unemployed{/menu_red} (disabled)" if not mom.has_job(unemployed_job):
            pass

        "We'll all be working together" if the_person.is_employee:
        ...
        "We'll all be working together\n{menu_red}Requires: Hire [the_person.title]{/menu_red} (disabled)" if not the_person.is_employee:
            pass
        ...
        "She's never going to graduate..." if lily.int <= 1:
            ...
            "[the_person.possessive_title!c]'s resolve seems to be wavering. You press your point."
        ...
        "She's never going to graduate...\n{menu_red}Requires: [lily.title] Int 1{/menu_red} (disabled)" if lily.int > 1:
            pass
...
label sister_cam_girl_online_view_label(the_person):
    # Tune into one of your sisters shows. Give her cash to do things as an anonymous donor.
    return
