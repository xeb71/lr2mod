...
# If an action has a valid requirement it can be assigned to a person in the matching list, and after n number of turns it will be removed, or removed when it's triggered.
...
label ask_new_title_label(the_person):
    $ the_person.set_event_day("ask_new_title")
    if renpy.random.randint(0, 1) == 1 and the_person.love > 0 and builtins.len(the_person.get_titles()) > 1: # 50/50
...
label work_walk_in_label(the_person): #Walk into the room and find someone masturbating (or maybe on talk instead?)
    ...
    $ the_person.set_event_day("work_walk_in")
    ...
    if the_person.effective_sluttiness() < 40: #She was masturbating, but is embarrassed about it.
            ...
            "Demand to know what she was doing" if the_person.obedience >= 120:
                ...
                menu:
                    "Praise her":
                        ...
                        $ the_person.change_slut(1 + the_person.opinion.masturbating, 35)
                    ...
                    "Scold her":
                        ...
                        $ the_person.change_stats(obedience = 2, slut = 1 + the_person.opinion.being_submissive, max_slut = 35)
                        if office_punishment.is_active:
                            ...
                            "[the_person.possessive_title!c] nods silently."
        ...
        $ mc.change_locked_clarity(10)
        if the_item:
            "You take a quiet step closer. She has one hand between her legs and underneath her [the_item.display_name], subtly rubbing her crotch."
        else:
        ...
        menu:
            "Interrupt her":
                ...
                "[the_person.possessive_title!c] yelps and nearly falls out of her chair."
                ...
                $ mc.change_locked_clarity(10)
                if the_item:
                    "[the_person.possessive_title!c] swivels her chair around to face you, wiping her hand off onto her thigh."
                else:
                    "[the_person.possessive_title!c] swivels her chair around to face you, wiping her hand off onto her [the_item.display_name]."
            ...
            "Just watch":
                ...
                if the_item:
                    "Her breathing is getting louder, and you can now hear the faint wet sounds as she fingers her pussy underneath her [the_item.display_name]."
                else:
                ...
                $ mc.change_locked_clarity(10)
                "[the_person.possessive_title!c] slumps in her chair, panting quietly. After taking a moment to recover she sits up and glances around."
                $ the_person.draw_person(position = "sitting")
                ...
                if the_person.opinion.public_sex < 0: #She's mortified
                ...
                elif the_person.opinion.public_sex == 0: #Normal
                    ...
                    $ the_person.change_arousal(15 * the_person.opinion.public_sex)
                    $ play_moan_sound()
                ...
                $ the_person.change_slut(1 + the_person.opinion.public_sex, 50)
        ...
        $ mc.change_locked_clarity(10)
        if the_item:
            "You take another step closer and see that she has her legs spread wide, with one hand underneath her [the_item.display_name] fingering her cunt."
        else:
            "You take another step closer and see that she has her legs spread wide, with one hand between them fingering her cunt."
        ...
        menu:
            "Let her finish":
                ...
                if the_person.opinion.public_sex < 0:
                    ...
                    menu:
                        "Make her cum":
                            ...
                            if the_report.get("girl orgasms", 0) > 0:
                                $ the_person.draw_person(position = "sitting", emotion = "orgasm")
                                "[the_person.possessive_title!c] collapses back into her chair and sighs happily."
                                mc.name "There, are you going to be able to focus now?"
                                "She nods obediently."
                                $ the_person.change_obedience(3 + the_person.opinion.being_submissive)
                                the_person "Yes [the_person.mc_title], thank you. What do you want to talk about?"
                            else:
                                $ the_person.draw_person(position = "sitting")
                                "[the_person.possessive_title!c] sits back down in her chair."
                ...
                elif the_person.opinion.public_sex > 0:
                    $ play_moan_sound()
                    ...
                    $ the_person.change_slut(2 + the_person.opinion.public_sex, 80)

                else:
                    the_person "Gladly! Ah!"
                    $ mc.change_locked_clarity(10)
                    "[the_person.possessive_title!c] cups a breast with one hand while she fingers herself with the other."
                    if office_punishment.is_active:
                        menu:
                            "Punish her for her inappropriate behaviour":
                                mc.name "This will go on your record, obviously. I may have to punish you for your inappropriate behaviour."
            ...
            "Demand she stops":
                ...
                if the_person.obedience - 100 > ((the_person.arousal/2) + 10*the_person.opinion.public_sex + 10*the_person.opinion.masturbating):
                    "[the_person.possessive_title!c] seems disappointed, but she puts her legs together and sits up straight in her chair."
                    $ mc.change_locked_clarity(5)
                    ...
                    $ the_person.change_stats(obedience = -2, slut = 2 + the_person.opinion.masturbating + the_person.discover_opinion("public sex"), max_slut = 80)
...
label work_spank_opportunity(the_person):
    ...
    if the_person.is_at_office:
        "When you walk in you see [the_person.possessive_title], leaning over a desk and staring at paperwork."
    else: # stripclub
        "When you walk in you see [the_person.possessive_title], leaning over a barstool looking at the stage."
    ...
    menu:
        "Slap her ass":
            ...
            if the_person.effective_sluttiness() + 5*the_person.opinion.being_submissive < 20 and not the_person.is_free_use:
            ...
            elif the_person.effective_sluttiness() + 5*the_person.opinion.being_submissive < 40:
                the_person "Oh!"
        ...
        "Grope her pussy" if the_person.vagina_available:
            ...
            if the_person.effective_sluttiness() + 5*the_person.opinion.being_fingered < 20 and not the_person.is_free_use:
                the_person "Oh my god!"
                $ the_person.draw_person(emotion = "angry")
                "She snaps straight up and spins around, glaring at you."
                $ the_person.change_stats(happiness = -10, slut = the_person.opinion.being_fingered, love = -2 + the_person.opinion.being_fingered)
                the_person "What the hell was that?"
                mc.name "I was just saying hi. It looked like you wanted it."
                the_person "Clearly I don't."
                "You hold your hands up innocently. She shakes her head and turns away from you."
            elif the_person.effective_sluttiness() + 5*the_person.opinion.being_fingered < 40:
                the_person "What the..."
                ...
                "You slide a finger inside her. She gasps and jumps, slamming her hips into the desk."
                ...
                $ the_person.change_slut(the_person.opinion.being_fingered)
                $ the_person.change_arousal(20+ 20*the_person.opinion.being_fingered)
                ...
                menu:
                    "Keep fingering her":
                        ...
                        $ the_person.change_arousal(10+10*the_person.opinion.being_fingered)
        ...
        "Enjoy the view":
            ...
            if the_person.effective_sluttiness() + 5*the_person.opinion.showing_her_ass < 15:
            ...
            elif the_person.effective_sluttiness() + 5*the_person.opinion.showing_her_ass < 40:
