...
label anal_fetish_employee_intro_label(the_person):
    ...
    "[the_person.possessive_title!c] has been dosed recently with some of your anal enhancing serums. You wonder if she is ready to awaken a new love of anal sex."
    ...
    call fuck_person(the_person, start_position = anal_standing, start_object = make_desk(), skip_intro = True, skip_condom = True) from _call_fuck_person_anal_fetish_intro_employee_01
    ...
    call advance_time(no_events = True) from _call_advance_time_anal_fetish_employee_intro
    return True
...
label anal_fetish_family_intro_label(the_person):
    ...
    elif the_person.has_taboo("condomless_sex") and not the_person.has_taboo("vaginal_sex"): #you've fucked but not bare
    ...
    call fuck_person(the_person, start_position = anal_standing, start_object = make_bed(), skip_intro = True, skip_condom = True) from _call_fuck_person_anal_fetish_intro_family_01
    $ the_person.max_opinion_score("anal sex")
    $ the_person.max_opinion_score("anal creampies")
...
label anal_fetish_generic_intro_label(the_person):
    ...
    menu:
        "Help her":
            if mc.location.person_count > 1:
                ...
                call mc_move_to_private_location(the_person) from _call_mc_move_to_private_location_anal_fetish_generic_intro
            else:
    ...
    call fuck_person(the_person, start_position = anal_standing, start_object = make_wall(), skip_intro = True, skip_condom = True) from _call_fuck_person_anal_fetish_intro_generic_01
    #$ the_person.SB_fetish = "anal sex"
    $ the_person.max_opinion_score("anal sex")
    $ the_person.max_opinion_score("anal creampies")
    ...
    "You part ways with [the_person.title], confident that her newfound anal fetish will bring you a lot of pleasure in the future."
    $ add_anal_fetish(the_person)
    call mc_restore_original_location(the_person) from _call_mc_restore_original_location_anal_fetish_generic_intro
    $ clear_scene() #TODO does this leave you talking to the girl? If so figure out how to part ways cleanly here.
    return True
...
label anal_fetish_mom_intro_label():
    ...
    "[the_person.possessive_title!c] has been dosed recently with some of your anal enhancing serums. She seems ready to awaken the love for anal sex."
    ...
    call get_fucked(the_person, the_goal = "anal creampie", private= True, start_position = anal_cowgirl, start_object = make_bed(), skip_intro = True, allow_continue = False) from _call_get_fucked_mom_anal_fetish_intro_02
    $ the_report = _return
...
label anal_fetish_lily_intro_label():
    ...
    call fuck_person(the_person, start_position = doggy_anal_dildo_dp, start_object = make_floor(), skip_intro = True, skip_condom = True) from _lily_anal_fetish_intro_01
    $ the_report = _return
    $ the_person.clear_situational_slut("situation")
    $ scene_manager.update_actor(the_person, position = "doggy")
...
label anal_fetish_stephanie_bimbo_label(the_person):
    ...
    $ the_person.break_taboo("anal_sex")
    call fuck_person(the_person, start_position = anal_standing, start_object = make_desk(), skip_intro = True, skip_condom = True, position_locked = True) from _call_steph_anal_intro_bimbo_01
    $ add_anal_fetish(the_person)
...
label anal_fetish_stephanie_normal_label(the_person):
    ...
    call get_fucked(the_person, the_goal = "anal creampie", start_position = anal_cowgirl, start_object = make_desk(), allow_continue = False) from _call_get_fucked_anal_fetish_steph_normal_intro_01
    $ add_anal_fetish(the_person)
...
label anal_fetish_erica_intro_label():
    ...
    call get_fucked(the_person, the_goal = "anal creampie", start_position = anal_cowgirl, start_object = make_bed(), skip_intro = True, allow_continue = False) from _call_get_fucked_anal_fetish_erica_intro_01
    $ add_anal_fetish(the_person)
...
label anal_fetish_camila_intro_label():
    return False
