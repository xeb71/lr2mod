label breeding_fetish_high_fertility_crisis_label():
    ...
    $ the_person.set_event_day("LastBreedingFetish")
    ...
    menu:
        ...
        "Disable this type of events for [the_person.fname]":
            $ the_person.event_triggers_dict["breeding_fetish_crisis_disabled"] = True
            $ clear_scene()
            return

    $ breeding_fetish_set_energy_levels(the_person)
...
label breeding_fetish_happy_breeder_crisis_label():
    ...
    menu:
        "Accept":  #This begins the sex scene
            ...
            $ the_person.break_taboo("condomless_sex")
            $ the_person.break_taboo("vaginal_sex")
            call fuck_person(the_person, start_position = facing_wall, start_object = make_window(), skip_intro = True, skip_condom = True) from _call_fuck_person_preg_breeder_nightscene_01
