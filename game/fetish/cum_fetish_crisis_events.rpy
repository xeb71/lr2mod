label cum_fetish_morning_shower_label():
    ...
    menu:
        "Let her join you":
            pass
        "Not today":
            mc.name "Not today, I'm in a hurry."
            "She looks a little disappointed, nods and leaves you to your shower."
        ...
        "Disable this type of events for [the_person.fname]":
            $ the_person.event_triggers_dict["cum_fetish_crisis_disabled"] = True
            $ clear_scene()
            return
