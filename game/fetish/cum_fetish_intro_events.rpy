...
label cum_fetish_employee_intro_label(the_person):
    ...
    "But for today you go home."
    $ mc.change_location(bedroom)
    call advance_time(no_events = True) from _call_advance_time_cum_fetish_employee_intro
    return True
...
label cum_fetish_mom_intro_label():
    ...
    menu:
        "Cum in her mouth":
            ...
            "With a little encouragement, you pull [the_person.possessive_title]'s head down a little farther with each stroke."
    ...
    "Wow! [the_person.possessive_title!c] just woke you up, in the middle of the night, with an amazing blowjob, took your load, then cuddled up and fell asleep with you."
    ...
    call fuck_person(the_person, start_position = sixty_nine, start_object = make_bed(), skip_intro = True, girl_in_charge = False, position_locked = True) from _call_fuck_mom_cum_fetish_intro_03
    $ the_report = _return
...
label cum_fetish_rebecca_intro_label(the_person):
    ...
    $ the_person.add_situational_slut("Thirsty", 10, "Needs your cum")
...
label cum_fetish_camila_intro_label():
    return False
