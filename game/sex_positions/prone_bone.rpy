...
label prone_decision_label(the_girl, the_location, the_object, the_position):
    "[the_girl.possessive_title!c] seems exhausted, but you are still full of vigour. You could probably push her down and fuck her prone, but she may or may not like it..."
    ...
    call check_position_willingness(the_girl, prone_bone, skip_dialog = True, skip_condom_ask = True) from _call_check_position_willingness_prone_decision
    if _return < 1:
    ...
    if the_girl.is_submissive:
        "[the_girl.possessive_title!c] gives a moan as you line yourself up and push back into her. She is completely helpless but submits to you obediently."
        $ the_girl.change_happiness(5)
    elif the_girl.is_dominant:
        the_girl "Are you serious? Can't we just take a quick break?..."
        "[the_girl.possessive_title!c]'s question gets cut off as you line yourself up and push back into her. She isn't happy with being used like this but is too tired to resist."
        $ the_girl.change_happiness(-5)
    else:
...
label intro_prone_bone(the_girl, the_location, the_object):
    ...
    $ play_moan_sound()
    "[the_girl.possessive_title!c] looks back at you as you line your cock up with her [the_girl.pubes_description] pussy. She moans as you slide into her."
    return
...
label taboo_break_prone_bone(the_girl, the_location, the_object):
    ...
    $ the_girl.call_dialogue(f"{prone_bone.associated_taboo}_taboo_break")
    the_girl "Okay, just don't do anything too crazy, okay?"
    $ the_girl.change_obedience(2)
    $ prone_bone.redraw_scene(the_girl)
    ...
    menu:
        "Threaten to creampie her" if not mc.condom:
            ...
            if the_girl.knows_pregnant:
                ...
                $ the_girl.change_arousal(5)
            elif the_girl.opinion.creampies < 0:
            ...
            menu:
                "Remove Condom":
                    ...
                    if the_girl.has_breeding_fetish:
                        ...
                        $ the_girl.change_arousal(10)
                        the_girl "That's it... now fuck me good [the_girl.mc_title]!"
                    elif the_girl.wants_creampie:
                    ...
                    $ the_girl.break_taboo("condomless_sex")
                    $ mc.condom = False
                    $ use_condom = False
                "Leave it on":
...
label outro_prone_bone(the_girl, the_location, the_object):
    ...
    if the_choice == "Cum inside her":
        $ play_moan_sound()
        "You use your full weight to push your cock deep inside [the_girl.possessive_title]'s cunt as you climax. She gasps and moans as you pin her to the [the_object.name]."
...
label prone_bone_double_orgasm(the_girl, the_location, the_object):
    ...
    if the_choice == "Cum inside her":
        ...
        if the_girl.has_cum_fetish:
            ...
            the_girl "What a waste, you should have filled me up."
