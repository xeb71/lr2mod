...
init python:
    gui.init(1920, 1080)
    config.ftfont_scale["fonts/OpenDyslexic3-Regular.ttf"] = .8
    config.ftfont_vertical_extent_scale["fonts/OpenDyslexic3-Regular.ttf"] = .65
    config.ftfont_vertical_extent_scale["fonts/trebuc.ttf"] = .8
...
## Colours ######################################################################
##
## The colours of text in the interface.

## An accent colour used throughout the interface to label and highlight text.
define gui.accent_color = '#0099cc'

## The colour used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#555555'

## The small colour is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#aaaaaa'

## The colour that is used for buttons and bars that are hovered.
define gui.hover_color = '#66c1e0'

## The colour used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#ffffff'

## The colour used for a text button when it cannot be selected.
define gui.insensitive_color = '#5555557f'

## Colours used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = '#003d51'
define gui.hover_muted_color = '#005b7a'

## The colours used for dialogue and menu choice text.
...
define gui.default_font = gui.preference("font", "fonts/boon-500.otf")

## The font used for character names.
define gui.name_font = gui.preference("font", "fonts/boon-500.otf")

## The font used for out-of-game text.
define gui.interface_font = gui.preference("font", "fonts/boon-500.otf")
...
define gui.main_menu_background = "images/background_images/LR2_Title.png"
define gui.game_menu_background = "images/background_images/LR2_Title.png"
