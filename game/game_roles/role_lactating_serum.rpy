...
label milk_for_serum_label(the_person):
    ...
    if not the_person.event_triggers_dict.get("been_milked_before", False):
        ...
        "[the_person.possessive_title!c] cocks an eyebrow, but waits for you to continue."
        ...
        if the_person.knows_pregnant:
            if the_person.effective_sluttiness() + 10* the_person.opinion.showing_her_tits > 40 and the_person.has_large_tits:
    ...
    if the_person.has_relation_with_mc or the_person.has_breeding_fetish or the_person.effective_sluttiness() + 5*the_person.opinion.showing_her_tits > 50:
        ...
        "[the_person.possessive_title!c] is unsure, but you think you might be able to convince her."
        menu:
            "I just need a little bit...":
                ...
                if the_person.breast_milk < 1:
                    ...
                    $ mc.log_event(f"Received 2 doses of {milk_serum.name}", "float_text_blue")
                    "She hands you the vial and quickly tries to change the subject."
                $ the_person.event_triggers_dict["recently_milked"] = True
                $ the_person.breast_milk = 0
            ...
            "I can pay you\n{menu_red}Costs: $200{/menu_red}" if mc.business.has_funds(200):
                ...
                $ mc.business.change_funds(-200, stat = "Investments")
    ...
    if milking_allowed:
        if the_person.effective_sluttiness("bare_tits") + 10*the_person.opinion.showing_her_tits < 30:
        ...
        if the_person.has_taboo("bare_tits") or (the_person.effective_sluttiness() < 30 and the_person.love < 30 and not the_person.has_relation_with_mc):
        ...
        $ the_person.event_triggers_dict["recently_milked"] = True
        $ available_doses = int(the_person.breast_milk)

        menu:
            "Milk her yourself" if the_person.effective_sluttiness() >= slut_requirement or the_person.has_relation_with_mc or the_person.has_breeding_fetish:
                ...
                if available_doses == 0:
                    ...
                    if the_person.lactation_sources == 1:
                        "[the_person.possessive_title!c]'s tits start to trickle milk into the bottle, one small squirt at a time."
                        ...
                        "[the_person.possessive_title!c]'s tits start to squirt milk into the bottle, one pulse at a time."
                        ...
                        "[the_person.possessive_title!c]'s tits jet milk at the lightest touch, making an audible splash with each massaged squirt."
                        "Her body seems eager to give up it's bounty, and you've milked her dry in a surprisingly short time."
                    else:
                        "[the_person.possessive_title!c]'s tits are dripping milk just being exposed, and they gush it into the bottle when you starts to massage them."
                    ...
                    menu:
                        ...
                        "Milk her {i}hard{/i}":
                            ...
                            if the_person.has_breeding_fetish or the_person.is_submissive:
                                ...
                                "[the_person.possessive_title!c] doesn't say anything more, other than a few suppressed groans."
                        ...
                        "Give her a fresh sample":
                            ...
                            if the_person.int < 3:
                                ...
                                the_person "Alright then, you're the expert here."
                            ...
                            menu:
                                ...
                                "Give her a tit" if the_person.has_large_tits and available_doses > 1:
                                    ...
                                    $ full_blast = False
                                    $ full_blast_string = f"{full_blast_amount} simultaneous doses!"
                                    ...
                                    if full_blast:
                                        ...
                                        if full_blast_amount == 2:
                                            ...
                                            "Her breast falls from her lips and bounces back to its natural position. She seems a little overwhelmed, but maintains her composure."
                                            ...
                                            "You let go of her head, and her breast jiggles back to its natural position."
                                            ...
                                            "Meanwhile, her tit jiggle back down to its natural position. A steady stream of milk continues to drip from her nipple, unwilling to stop once it's been started."
                                            mc.name "Well, how was it?"
                                            "[the_person.possessive_title!c] needs a moment to catch her breath before she can answer."
                                        ...
                                        "She lets her bounce back to its natural position."
                    ...
                    if available_doses > 0:
                        ...
                        $ mc.log_event(f"Received {available_doses} dose of {milk_serum.name}", "float_text_blue")
            ...
            "Let her milk herself":
                ...
                if available_doses == 0:
                    ...
                    if the_person.lactation_sources == 1:
                        ...
                        "[the_person.possessive_title!c]'s tits are dripping milk just being exposed, and they gush it into the bottle when she starts to massage them."
                        "You aren't sure how she avoid soaking through every single bra and shirt she puts on!"
                        if the_person.has_large_tits:
