...
label employee_freeuse_report_label(the_person):
    ...
    if the_person.effective_sluttiness() > 80 and the_person.opinion.being_submissive + the_person.event_triggers_dict.get("freeuse orgasms", 0) > 3: #You have to make her cum, more is better depending on her opinion.
        ...
        "[the_person.possessive_title!c] looks up at you, a sudden hunger in her eyes."
...
label employee_freeuse_fuck(the_person):
    ...
    if the_person.event_triggers_dict.get("willing_freeuse", False):
        ...
        $ the_person.add_situational_obedience("freeuse", 30, "This is what I wanted. I want him to tell me what to do, even if I don't want to do it.")
    else:
        mc.name "Come here, I'm horny."
        "[the_person.possessive_title!c] nods obediently."
        $ the_person.add_situational_obedience("freeuse", 30, "This is part of my punishment, I agreed to this and I can't say no.")

    if the_person.is_submissive:
        $ the_person.add_situational_slut("freeuse", 5*the_person.opinion.being_submissive, "Someone using me, just like a toy... It's making me so wet!")
    elif the_person.is_dominant:
        $ the_person.add_situational_slut("freeuse", 5*the_person.opinion.being_submissive, "I'm being used like a toy, it feels so heartless!")
