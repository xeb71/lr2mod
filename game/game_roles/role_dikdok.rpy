...
init -2 python:
    ...
    def build_dikdok_menu():
        ...
        dikdok_list.extend((x for x in mc.phone.get_person_list() if x.dikdok_known))
...
label check_dikdok():
    ...
    call screen main_choice_display(build_menu_items(build_dikdok_menu(), draw_hearts_for_people = False, draw_person_previews = False, draw_dikdok = True))
    if isinstance(_return, Person):
        call view_dikdok(_return) from _call_view_dikdok
    return
...
label view_dikdok(the_person):
    if the_person.event_triggers_dict.get("dikdok_generate_video", False) or the_person.event_triggers_dict.get("dikdok_force_video", False):
        ...
        if the_person.event_triggers_dict.get("dikdok_new_boobs_brag", False):
            ...
            $ clear_scene()
            "[the_person.possessive_title!c] slides her hand in front of the camera."
            ...
            if ran_num == 0:
                "[the_person.possessive_title!c] just filmed her food. She isn't even in the shot."
            elif ran_num == 1:
            ...
            if ran_num == 0:
                ...
                "[the_person.possessive_title!c] is curled up on the couch with a steaming drink and a book on her lap."
                "She blows a kiss to the camera, then the video ends."
                $ clear_scene()
            else:
                $ the_person.apply_planned_outfit()
                $ the_person.draw_person()
                "[the_person.possessive_title!c] is leaning towards to her bathroom mirror, giving a close-up of her lips."
            ...
            if ran_num == 0:
                ...
                $ the_person.draw_person()
                "[the_person.possessive_title!c] is standing in front of her bedroom mirror, and showing off her body."
                ...
                $ the_person.apply_outfit(the_person.personalize_outfit(insta_wardrobe.pick_random_outfit())) #TODO: We might want a dedicated athletics wardrobe at some point.
                $ the_person.draw_person()
                "[the_person.possessive_title!c] is holding her phone out and filming herself as she jogs down a residential street."
                ...
                "[the_person.possessive_title!c] is on her knees, and still propping up her phone when the video starts."
                ...
                $ the_person.draw_person(position = "doggy")
                "She keeps shaking her butt for her digital audience until the song and the video end."
                $ the_person.apply_planned_outfit()
                $ clear_scene()
            else:
                $ the_person.apply_outfit(the_person.personalize_outfit(lingerie_wardrobe.pick_random_outfit()))
                ...
                if the_person.has_large_tits:
                    ...
                    "[the_person.possessive_title!c] looks down at her own cleavage and smiles."
                else:
                    $ the_person.draw_person(position = "kneeling1")
            ...
            if ran_num == 0: # Short JOI in some lingerie.
                ...
                "[the_person.possessive_title!c] licks her lips slowly and pulls teasingly at her underwear."
                ...
                $ the_person.draw_person(position = "kneeling1")
                "[the_person.possessive_title!c] sucks on the fake dick, working it farther and farther into her mouth in time with the music."
                $ mc.change_locked_clarity(20)
                ...
                "[the_person.possessive_title!c]'s dance goes on for a little longer, then she reaches for her phone and the video ends."
                $ the_person.apply_planned_outfit()
                $ clear_scene()
