label stripper_private_dance_label(the_person):
    if the_person.has_role(cousin_role):
        ...
        "[the_person.possessive_title!c] glares at you and rolls her eyes."
        ...
        "[the_person.possessive_title!c] shoves you towards the padded bench and snaps the curtain closed behind both of you."
        $ the_person.draw_person()
        the_person "Money. Now."
        menu:
            "Pay her\n{menu_red}Costs: $100{/menu_red}":
                mc.name "Alright, alright. Calm down, I'm a man of my word."


            "Tits first\n{menu_red}Costs: $100{/menu_red}" if not the_person.tits_visible:
        ...
        "[the_person.possessive_title!c] gets dressed and pulls the curtain back, hurrying out into the main showroom without waiting for you."
        "You follow after her a few moments later."
    else:
        mc.name "Do you do private dances?"
        "[the_person.possessive_title!c] looks you up and down and smiles."
        ...
        $ the_person.draw_person(position = "walking_away")
        "She brushes her fingers over your upper arm, then turns around and leads you towards a series of curtain-obscured booths."
        ...
        menu:
            ...
            "Stuff the cash into her cleavage\n{menu_red}Costs: $100{/menu_red}" if the_person.outfit.get_upper_top_layer:
                "You pull out your wallet and retrieve [the_person.title]'s money."
                $ mc.business.change_funds(-100, stat = "Strippers")
                "She waits patiently as you tuck the bills under the edge of her [the_person.outfit.get_upper_top_layer.display_name]."
        ...
        $ the_person.draw_person(position = "walking_away")
        "She slides the curtain open and walks out into corridor back to the main stage."
        $ clear_scene()
...
label stripper_offer_hire(the_person):
    ...
    if get_strip_club_foreclosed_stage() == 0 and the_person.is_at(strip_club_hub):
        ...
        if the_person.opinion(("showing her ass", "showing her tits")) < 0: #Happy to get out of here
            ...
            if the_person.opinion(("showing her ass", "showing her tits")) > 0:
                the_person "And it's pretty fun, honestly. There's nothing quite like being up on stage and being the centre of attention."

            the_person "It would take a lot to convince me to quit."
            menu:
                "Quit for me" if the_person.has_relation_with_mc:
                ...
                "Quit for me\n{menu_red}Requires: Girlfriend or Paramour{/menu_red} (disabled)" if not the_person.has_relation_with_mc:
                    pass

                "Pay her double normal wage":
...
label stripper_hire_accept(the_person):
    ...
    if _return:
        ...
        if strip_club_is_closed() or mc.owns_strip_club:
            the_person "Thanks, [the_person.mc_title], see you at work."
            if strip_club_is_closed(): # make sure we have 4 strippers when we buy the club
                $ create_stripper()
        else:
            ...
            $ create_stripper() # make sure we always have 4 stripper prior to buying strip club
    else:
