...
label trance_train_label(the_person):
    if the_person.has_exact_role(trance_role):
        ...
        "[the_person.possessive_title!c]'s eyes are unfocused, her mouth slightly slack."
        "It's painfully obvious that her thoughts are somewhere else entirely, and that makes her open to all types of influences."
