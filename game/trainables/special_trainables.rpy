...
label train_breeder_label(the_person):
    ...
    if the_person.has_significant_other:
        the_person "Maybe my [the_person.so_title]?"
        mc.name "Not even close. Want to know what they are?"
    elif the_person.has_relation_with_mc:
        the_person "Maybe you?"
        mc.name "That's very sweet, but no, even more than me. Want to know what they are?"
    else:
        "[the_person.possessive_title!c] tries to summon up an answer, but her cum-addled brain can't quite come up with anything."
    ...
    if the_person.effective_sluttiness() > 50:
        "[the_person.possessive_title!c] doesn't argue, she just nods in agreement and stares into your eyes."
    else:
        the_person "No... I..."
    ...
    "[the_person.possessive_title!c] crosses her legs and squirms a little, obviously suddenly eager for some pleasure."
    ...
    if the_person.kids == 0:
        ...
        the_person "Excited... My [the_person.so_title] doesn't understand what it's like to want something so badly!"
    else:
    ...
    "[the_person.possessive_title!c] nods and repeats."
...
label train_hypnotic_orgasm(the_person):
    ...
    $ the_word = renpy.input("Pick her trigger (Default: 'Cum')", default = 'Cum', length = 80, exclude="[]{}").strip()
    while not the_word or len(the_word) == 0:
        $ the_word = renpy.input("Pick her trigger (Default: 'Cum')", the_word, length = 80, exclude="[]{}").strip()
    ...
    menu:
        ...
        "Play with her a little":
            ...
            the_person "Say it... Please [the_person.mc_title], say it!"
            $ mc.change_locked_clarity(20)
            "She gasps and twitches, hanging uncomfortably at the edge of climax."
            mc.name "Hmmm... what was that again?"
...
label train_online_attention_whore(the_person):
    ...
    if not the_person.has_role(instapic_role):
        menu:
            "Make her an InstaPic account":
                ...
                "[the_person.possessive_title!c] blushes and shrugs, but it's clear the answer is yes."
        ...
        menu:
            "Make her an OnlyFanatics account":
                ...
                if the_person.age < 40:
                    ...
                    "[the_person.possessive_title!c] doesn't seem to immediately understand, so you keep explaining."
    ...
    if set_something_up:
        ...
        if the_person.sluttiness < 30:
            "[the_person.possessive_title!c] shrugs, pretending not to be interested."
