label train_slut_label(the_person):
    ...
    "[the_person.possessive_title!c] nods her head passively, her orgasm-trance making her easier to manipulate."
...
label train_love_label(the_person):
    ...
    "[the_person.possessive_title!c] doesn't seem entirely convinced, but her mind is too addled to argue."
...
label train_suggest_label(the_person):
    ...
    "You spend some time weakening [the_person.possessive_title]'s defences against slipping into a trance when she cums."
    return True
